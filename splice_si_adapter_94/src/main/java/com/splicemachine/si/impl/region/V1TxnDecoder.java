 ...
 *         Date: 8/18/14
 */
public class V1TxnDecoder<Put extends OperationWithAttributes,Delete,Get extends OperationWithAttributes, Scan> extends AbstractV1TxnDecoder<SparseTxn,SparseTxn,KeyValue,Put,Delete,Get,Scan>{
