...
extends InputFormat<ImmutableBytesWritable, ExecRow> {
  ...
  final Log LOG = LogFactory.getLog(SpliceTableInputFormatBase.class);
  ...
  private SpliceTableRecordReaderBase tableRecordReader = null;
  ...
  throws IOException {
    ...
    if (trr == null) {
      trr = new SpliceTableRecordReaderBase();
    }
   ...
   *   implementation.
   */
  protected void setTableRecordReader(SpliceTableRecordReaderBase tableRecordReader) {
