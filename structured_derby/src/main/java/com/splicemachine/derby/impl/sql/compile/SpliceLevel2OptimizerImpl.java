 ...
 */
public class SpliceLevel2OptimizerImpl extends OptimizerImpl {
    private static final Logger LOG = Logger.getLogger(SpliceLevel2OptimizerImpl.class);
	private LanguageConnectionContext lcc;

	SpliceLevel2OptimizerImpl(OptimizableList optimizableList, 
	...
	public CostEstimateImpl getNewCostEstimate(double theCost,
			double theRowCount,double theSingleScanRowCount) {
