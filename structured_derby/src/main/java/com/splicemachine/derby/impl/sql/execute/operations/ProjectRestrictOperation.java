...
public class ProjectRestrictOperation extends SpliceBaseOperation {
	...
	public ExecRow nextRow(SpliceRuntimeContext spliceRuntimeContext) throws StandardException, IOException {
		...
		do {
            ...
            System.out.println(">>>   PRO: Candidate: "+candidateRow);
			if (candidateRow != null) {
				...
				if (restriction == null) {
					...
					if (! restrict) {
                        System.out.println(">>>   PRO: Candidate Filtered: "+candidateRow);
						rowsFiltered++;
					}
				}
				rowsSeen++;
		...
		if (candidateRow != null)  {
            ...
            System.out.println(">>>   PRO Result: "+result);
		}
...
//	}
    ...
    public void open() throws StandardException, IOException {
        super.open();
        System.out.println(">>>   PRO: Opening "+(source != null ? source.getClass().getSimpleName() : "null source"));
	...
	public void	close() throws StandardException, IOException {
        ...
        System.out.println(">>>   PRO: Closing "+(source != null ? source.getClass().getSimpleName() : "null source"));
				super.close();
				source.close();
