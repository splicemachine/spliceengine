...
public class SITableScanner implements StandardIterator<ExecRow> {
    ...
    private List<org.apache.hadoop.hbase.Cell> keyValues;
            ...
            this.filterFactory = new SIFilterFactory() {
                ...
                public SIFilter newFilter(EntryPredicateFilter predicateFilter,
                    ...
                    return new FilterStatePacked((FilterState) iFilterState, hRowAccumulator) {
                        @Override
                        public Filter.ReturnCode doAccumulate(org.apache.hadoop.hbase.Cell dataKeyValue) throws IOException {
    ...
    private boolean filterRow(SIFilter filter) throws IOException {
        filter.nextRow();
        Iterator<org.apache.hadoop.hbase.Cell> kvIter = keyValues.iterator();
        while (kvIter.hasNext()) {
            org.apache.hadoop.hbase.Cell kv = kvIter.next();
    ...
    private boolean filterRowKey(org.apache.hadoop.hbase.Cell keyValue) throws IOException {
