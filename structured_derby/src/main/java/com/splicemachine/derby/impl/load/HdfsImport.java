...
public class HdfsImport extends ParallelVTI {
	...
	public static ResultSet importData(Connection connection,
		...
		HdfsImport importer = new HdfsImport(inputFileName,tableName,conglomId,delimiter,columnTypes,activeCols);
		try {
			importer.open();
	...
	public HdfsImport(String filePath, String tableName,long conglomId,String delimiter,
	...
	public void executeShuffle() throws StandardException {
		...
		try {
			...
			insertedRowCount+=rowsImported.get();
		} catch (IOException e) {
