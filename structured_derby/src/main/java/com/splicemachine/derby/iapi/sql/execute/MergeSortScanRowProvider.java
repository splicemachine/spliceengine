...
public class MergeSortScanRowProvider implements RowProvider {
	private static final Logger LOG = Logger.getLogger(MergeSortScanRowProvider.class);
	...
	public MergeSortScanRowProvider(String table, Scan scan,ExecRow row){
		this(Bytes.toBytes(table),scan,row);
	}
	
	public MergeSortScanRowProvider(byte[] table, Scan scan,ExecRow row){
		this(table,scan,row,null);
	}
	
	public MergeSortScanRowProvider(byte[] table, Scan scan,ExecRow row,FormatableBitSet fbt){
		this.table = table;
		this.scan = scan;
		this.currentRow = row;
		this.fbt = fbt;
	...
	public MergeSortScanRowProvider(String table, Scan scan,ExecRow row,FormatableBitSet fbt){
