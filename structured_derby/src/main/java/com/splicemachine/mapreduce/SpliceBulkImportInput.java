...
public class SpliceBulkImportInput extends FileInputFormat<Text,Text> {
		  ...
		  public static void writePartitionFile(final JobContext job, 
		    ...
		    final SpliceBulkImportInput inFormat = new SpliceBulkImportInput();
		  ...
		  public List<InputSplit> getSplits(JobContext job) throws IOException {
		    ...
		    if (job.getConfiguration().getBoolean(SpliceScheduler.USE, true)) {
		      SpliceScheduler scheduler = new SpliceScheduler(
