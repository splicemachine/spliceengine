...
public class BalancedBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E> {
    ...
    */
    ...
    private final Function<E,Integer> priorityMapper;

    public BalancedBlockingQueue(int numLevels,int levelBound,Function<E,Integer> priorityMapper) {
    ...
    private Level<E> getLevel(E e) {
        ...
        int level = priorityMapper.apply(e);
