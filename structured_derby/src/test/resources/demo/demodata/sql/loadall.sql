...
call SYSCS_UTIL.IMPORT_DATA('SPLICE','T_HEADER',null,'demodata/data/theader.csv.gz',',',null,null,null,null,0,null);
call SYSCS_UTIL.IMPORT_DATA('SPLICE','T_DETAIL',null,'demodata/data/tdetail.csv.gz',',',null,null,null,null,0,null);
call SYSCS_UTIL.IMPORT_DATA('SPLICE','CUSTOMERS',null,'demodata/data/customers.csv.gz',',',null,null,null,null,0,null);
