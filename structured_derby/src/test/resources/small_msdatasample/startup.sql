...
call SYSCS_UTIL.SYSCS_IMPORT_DATA ('<SCHEMA>', 'CATEGORY', null, null, '${basedir}/src/test/resources/small_msdatasample/category.csv', ',', '"', null);
...
call SYSCS_UTIL.SYSCS_IMPORT_DATA ('<SCHEMA>', 'CATEGORY_SUB', null, null, '${basedir}/src/test/resources/small_msdatasample/category_sub.csv', ',', '"', null);
...
CREATE TABLE customer (
	...
	cst_recency		INT,
	cst_status_id		INT);
call SYSCS_UTIL.SYSCS_IMPORT_DATA ('<SCHEMA>', 'CUSTOMER', null, null, '${basedir}/src/test/resources/small_msdatasample/customer_iso.csv', ',', '"', null);
...
call SYSCS_UTIL.SYSCS_IMPORT_DATA ('<SCHEMA>', 'ITEM', null, null, '${basedir}/src/test/resources/small_msdatasample/item.csv', ',', '"', null);
...
CREATE TABLE order_header (
	...
	orh_rush		INT);
call SYSCS_UTIL.SYSCS_IMPORT_DATA ('<SCHEMA>', 'ORDER_HEADER', null, null, '${basedir}/src/test/resources/small_msdatasample/order_header.csv', ',', '"', null);
...
CREATE TABLE order_line (
	...
	orl_discount 		FLOAT, 
	orl_customer_id 	INT);
call SYSCS_UTIL.SYSCS_IMPORT_DATA ('<SCHEMA>', 'ORDER_LINE', null, null, '${basedir}/src/test/resources/small_msdatasample/order_line.csv', ',', '"', null);
