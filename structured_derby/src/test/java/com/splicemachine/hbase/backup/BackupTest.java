...
public class BackupTest {
	/*
	@Test
	public void testCreateBackup() throws SQLException {
		Backup backupNoParent = Backup.createBackup("file:///chiken/dinner", BackupScope.D, -1L);
	...
	public void testCreateBackupWithLargerParentTimestamp() throws SQLException {
		Backup.createBackup("file:///chiken/dinner", BackupScope.D, Long.MAX_VALUE);
	}
	
	@Test
	public void testMarkBackupFailed() throws SQLException {
		Backup backupNoParent = Backup.createBackup("file:///chiken/dinner", BackupScope.D, -1L);
	...
	@Test
	public void testMarkBackupSuccesful() throws SQLException {
		Backup backupNoParent = Backup.createBackup("file:///chiken/dinner", BackupScope.D, -1L);
