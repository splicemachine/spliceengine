 ...
 * @see UniqueIndexTest
 */
public class WriteWriteRollbackTest extends SpliceUnitTest {
    public static final String CLASS_NAME = WriteWriteRollbackTest.class.getSimpleName().toUpperCase();
