...
//            .around(spliceTableWatcher41)
            ...
            .around(new SpliceDataWatcher() {
                ...
                protected void starting(Description description) {
                    try {
                        if (true) {
                            PreparedStatement ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_1 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_2 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_3 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_4 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_5 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_6 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_7 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_8 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_9 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_10 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_11 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_12 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_13 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_14 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_15 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_16 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_17 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
                            ps = spliceClassWatcher.prepareStatement("call SYSCS_UTIL.SYSCS_IMPORT_DATA('" + CLASS_NAME + "','" + TABLE_18 + "',null,null,'" + getResource("testnegdata.csv") + "',',','\"',null,null,null)");
                            ps.execute();
