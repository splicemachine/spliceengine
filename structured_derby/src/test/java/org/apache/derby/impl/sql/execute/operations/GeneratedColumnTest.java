...
public class GeneratedColumnTest {
    ...
    private static final Logger LOG = Logger.getLogger(GeneratedColumnTest.class);
    private static final String CLASS_NAME = GeneratedColumnTest.class.getSimpleName().toUpperCase();
