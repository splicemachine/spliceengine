 ...
 */
//@Ignore("Bug 334")
public class RowCountOperationIT extends SpliceUnitTest {
		protected static SpliceWatcher spliceClassWatcher = new SpliceWatcher();
		public static final String CLASS_NAME = RowCountOperationIT.class.getSimpleName().toUpperCase();
...
//			Assert.assertEquals(i,val);
		...
		@Test
		@Ignore("DB-2274")
		public void testRepeatedCountOffset() throws Exception {
			for(int i=0;i<100;i++){
					testCountOffset();
			}
		}
