...
public class DataTypeCheckNegIT extends SpliceUnitTest {
    ...
    String[] bTables = new String[]{TABLE_50, TABLE_51};
    ...
    private void runAndTestQueryRI(String query, int lookFor, String column) throws Exception {
        ResultSet rs = methodWatcher.executeQuery(query);
        if (rs.next()) {
            int actualValue = rs.getInt(column);
            assertEquals("query=" + query, lookFor, actualValue);
        }
        rs.close();
    }
    ...
    private void runAndTestQueryRS(String query, String expectedValue, String column) throws Exception {
        ...
        if (rs.next()) {
            ...
            assertEquals("query=" + query, expectedValue, actualValue);
        }
        rs.close();
    }
    ...
    public void testSmallInt() throws Exception {
        ...
        for (String table : tables) {
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where smallint1 between -1 and -3", -3, -2, -1, "smallint1");
            runAndTestQueryRI("select count(*) as retval from " + CLASS_NAME + "." + table + " group by smallint1 having smallint1 = -2", 1, "retval");
            runAndTestQueryRI("select * from " + CLASS_NAME + "." + table + " where smallint2 = -1", -1, "smallint2");
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where smallint2 between -3 and -1", -3, -2, -1, "smallint2");
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where smallint3 between -3 and -1", -3, -2, -1, "smallint3");
    ...
    public void testInteger() throws Exception {
        ...
        for (String table : tables) {
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where integer1 between -3 and -1", -3, -2, -1, "integer1");
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where integer2 between -3 and -1", -3, -2, -1, "integer2");
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where integer3 between -3 and -1", -3, -2, -1, "integer3");
    ...
    public void testBigInt() throws Exception {
        ...
        for (String table : tables) {
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where bigint1 between -3 and -1", -3, -2, -1, "bigint1");
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where bigint2 between -3 and -1", -3, -2, -1, "bigint2");
            ...
            runAndTestQueryR3("select * from " + CLASS_NAME + "." + table + " where bigint3 between -3 and -1", -3, -2, -1, "bigint3");
    ...
    public void testDecimal() throws Exception {
        ...
        for (String table : tables) {
            ...
            runAndTestQueryR3D("select * from " + CLASS_NAME + "." + table + " where decimal1 between -3.0 and -1.0", -3.0, -2.0, -1.0, "decimal1");
            ...
            runAndTestQueryR3D("select * from " + CLASS_NAME + "." + table + " where decimal2 between -3 and -1", -3.0, -2.0, -1.0, "decimal2");
            ...
            runAndTestQueryR3D("select * from " + CLASS_NAME + "." + table + " where decimal3 between -3 and -1", -3.0, -2.0, -1.0, "decimal3");
    ...
    public void testFloat() throws Exception {
        ...
        for (String table : tables) {
            ...
            runAndTestQueryR3D("select * from " + CLASS_NAME + "." + table + " where float1 between -2.5 and -1.5", -2.5, -2.0, -1.5, "float1");
            ...
            runAndTestQueryR3D("select * from " + CLASS_NAME + "." + table + " where float2 between -2.5 and -1.5", -2.5, -2.0, -1.5, "float2");
            ...
            runAndTestQueryR3D("select * from " + CLASS_NAME + "." + table + " where float3 between -2.5 and -1.5", -2.5, -2.0, -1.5, "float3");
    ...
    public void testJoinsSmallint() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.smallint1=b.smallint1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.smallint1=b.smallint1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.smallint1=b.smallint1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsBigint() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.bigint1=b.bigint1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.bigint1=b.bigint1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.bigint1=b.bigint1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsInteger() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.integer1=b.integer1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.integer1=b.integer1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.integer1=b.integer1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsDecimal() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.decimal1=b.decimal1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.decimal1=b.decimal1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.decimal1=b.decimal1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsDouble() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.double1=b.double1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.double1=b.double1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.double1=b.double1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsFloat() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.float1=b.float1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.float1=b.float1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.float1=b.float1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsDate() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.date1=b.date1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.date1=b.date1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.date1=b.date1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
    ...
    public void testJoinsTime() throws Exception {
        int lf[] = {1, 1, 1};
        String query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.AAA as b  on a.time1=b.time1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.AAA as a join DataTypeCheckNegIT.BBB as b  on a.time1=b.time1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
        query = "select count(*) as retval from DataTypeCheckNegIT.BBB as a join DataTypeCheckNegIT.BBB as b  on a.time1=b.time1 group by a.timestamp1,b.time2 having cast(a.timestamp1 as time) <= b.time2";
        runAndTestQueryRI3(query, lf, "retval");
    }
