...
public class BaseTest extends SchemaConstants {
	...
	public final static String TRANSACTION_PATH = "/Transaction";
	public final static String SCHEMA_PATH = "/Schema";
	...
	public static void basicConf() throws Exception {
		...
		hbaseTestingUtility.getConfiguration().set(SCHEMA_PATH_NAME, DEFAULT_SCHEMA_PATH);
		hbaseTestingUtility.getConfiguration().set(TxnConstants.TRANSACTION_PATH_NAME, TxnConstants.DEFAULT_TRANSACTION_PATH);
