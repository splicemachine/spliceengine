...
-- setup
--Bug 465     UPDATE STAFF
--Bug 465          SET GRADE=10*STAFF.GRADE
--Bug 465          WHERE STAFF.EMPNUM NOT IN
--Bug 465                (SELECT WORKS.EMPNUM
--Bug 465                      FROM WORKS
--Bug 465                      WHERE STAFF.EMPNUM = WORKS.EMPNUM);
