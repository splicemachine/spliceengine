...
--Bug 574            SELECT COUNT(*)
--Bug 574            FROM WORKS
--Bug 574            WHERE HOURS BETWEEN -40 AND -80;
-- PASS:0269 If count = 0?

--Bug 574            SELECT COUNT(*)
--Bug 574            FROM WORKS
--Bug 574            WHERE HOURS BETWEEN -80 AND -40;
...
--Bug 575            SELECT COUNT(*)
--Bug 575            FROM WORKS,STAFF
--Bug 575            WHERE WORKS.EMPNUM = 'E1';
