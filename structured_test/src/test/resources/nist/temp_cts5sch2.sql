...
--  CITY   CHAR(15));
  ...
  CREATE TABLE STAFF3
  (EMPNUM   VARCHAR(3) NOT NULL PRIMARY KEY,
--   EMPNAME  CHAR(20),
   EMPNAME  VARCHAR(20),
   GRADE    DECIMAL(4),
--   CITY     CHAR(15));
...
--     EMPNAME CHAR(20));
  ...
  CREATE TABLE STAFFz
--( EMPNUM VARCHAR(3) REFERENCES STAFF3(EMPNUM),
  ( EMPNUM VARCHAR(3),
...
--  (D   CHAR,
  ...
  (TX1     INTEGER,
--   TX2     CHARACTER(5),
   TX2     CHARACTER VARYING(5),
   TX3     CHARACTER VARYING (10));

  CREATE TABLE COMP_BUDG
  (P_REF   VARCHAR(3) NOT NULL,
   BUDGET  DECIMAL(20),
   HOURS   INTEGER,
   SALARY  DECIMAL(6));
...
--  ( MGR    CHAR(15)  REFERENCES CTS2.PROJ_MAN(MGR),
  ( MGR    VARCHAR(15)  REFERENCES CTS2.PROJ_MAN(MGR),
    P_REF  VARCHAR(3),
    ONTIME CHAR,
    BUDGET DECIMAL(20),
    COST   DECIMAL(20));
