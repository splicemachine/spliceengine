...
--O  CREATE TABLE ECCO (C1 VARCHAR(2));
  ...
  CREATE TABLE STAFF
-- Bug 202   (EMPNUM   VARCHAR(3) NOT NULL,
   (EMPNUM   VARCHAR(3),
    EMPNAME  VARCHAR(20),
    GRADE    DECIMAL(4),
    CITY     VARCHAR(15));
  ...
  CREATE TABLE PROJ
-- Bug 202   (PNUM     VARCHAR(3) NOT NULL,
   (PNUM     VARCHAR(3),
...
-- Bug 202        CREATE TABLE STAFF4 (EMPNUM    VARCHAR(3) NOT NULL,
        CREATE TABLE STAFF4 (EMPNUM    VARCHAR(3),
-- Bug 379               EMPNAME  VARCHAR(20) DEFAULT NULL,
-- Bug 202                EMPNAME  VARCHAR(20) DEFAULT NULL,
                EMPNAME  VARCHAR(20),
--O                GRADE DECIMAL(4) DEFAULT 0,
--O                CITY   VARCHAR(15) DEFAULT '               ');
                GRADE DECIMAL(4) ,
                CITY   VARCHAR(15) );


-- Bug 202        CREATE TABLE STAFF14 (EMPNUM    VARCHAR(3) NOT NULL,
        CREATE TABLE STAFF14 (EMPNUM    VARCHAR(3),
...
-- Bug 202        CREATE TABLE STAFF5 (EMPNUM    VARCHAR(3) NOT NULL,
        CREATE TABLE STAFF5 (EMPNUM    VARCHAR(3),
                EMPNAME  VARCHAR(20),
                GRADE DECIMAL(4),
                CITY   VARCHAR(15),
                PRIMARY KEY (EMPNUM));
...
-- Bug 202        CREATE TABLE STAFF6 (EMPNUM    VARCHAR(3) NOT NULL,
--Bug 379                EMPNAME  VARCHAR(20),
        CREATE TABLE STAFF6 (EMPNUM    VARCHAR(3),
                EMPNAME  VARCHAR(20),
                GRADE DECIMAL(4),
-- Bug 263                CONSTRAINT STAFF6_GRADE CHECK (GRADE > 0 AND GRADE < 20),
                CITY   VARCHAR(15));

-- Bug 202        CREATE TABLE STAFF7 (EMPNUM    VARCHAR(3) NOT NULL,
-- Bug 379                EMPNAME  VARCHAR(20),
         CREATE TABLE STAFF7 (EMPNUM    VARCHAR(3),
                EMPNAME  VARCHAR(20),
                GRADE DECIMAL(4),
                CITY   VARCHAR(15),
...
-- Bug 202        CREATE TABLE STAFF8 (EMPNUM    VARCHAR(3) NOT NULL,
        CREATE TABLE STAFF8 (EMPNUM    VARCHAR(3),
-- Bug 379                EMPNAME  VARCHAR(20),
                GRADE DECIMAL(4),
                CITY   VARCHAR(15),
                PRIMARY KEY (EMPNUM));
...
-- Bug 202        CREATE TABLE STAFF9 (EMPNUM    VARCHAR(3) NOT NULL,
        CREATE TABLE STAFF9 (EMPNUM    VARCHAR(3),
...
-- Bug 202        CREATE TABLE STAFF10 (EMPNUM    VARCHAR(3) NOT NULL,
        CREATE TABLE STAFF10 (EMPNUM    VARCHAR(3),
-- Bug 379                EMPNAME  VARCHAR(20),
                EMPNAME  VARCHAR(20),
                GRADE DECIMAL(4),
                CITY   VARCHAR(15),
...
-- Bug 379,202                EMPNAME  VARCHAR(20) DEFAULT NULL,
                EMPNAME  VARCHAR(20),
-- Bug263                GRADE DECIMAL(4) NOT NULL CHECK (GRADE IN (100,150,200)),
