...
public class SIConstants extends SpliceConstants {
	...
	public static final int SNAPSHOT_ISOLATION_ANTI_TOMBSTONE_COLUMN = 0;
    public static final int SNAPSHOT_ISOLATION_TOMBSTONE_COLUMN = 1;
    public static final int SNAPSHOT_ISOLATION_COMMIT_TIMESTAMP_COLUMN = 2;
    ...
    public static final String SNAPSHOT_ISOLATION_ANTI_TOMBSTONE_COLUMN_STRING = SNAPSHOT_ISOLATION_ANTI_TOMBSTONE_COLUMN + "";
	...
	public static final byte[] SNAPSHOT_ISOLATION_ANTI_TOMBSTONE_COLUMN_BYTES = Bytes.toBytes(SNAPSHOT_ISOLATION_ANTI_TOMBSTONE_COLUMN_STRING);		
