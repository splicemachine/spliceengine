/*
   ...
   Derby - Class com.splicemachine.db.impl.tools.ij.xaHelper
...
class xaHelper implements xaAbstractHelper
{
  ...
  xaHelper()
  {
		 ...
		 throws SQLException
	{
		...
		try {
			currentDataSource = (DataSource) (Class.forName("com.splicemachine.db.jdbc.EmbeddedDataSource").newInstance());
		} catch (Exception e) {
		...
		try
		{
            ...
            if (isJCC)
               return (XADataSource) 
                ...
                return (XADataSource)(Class.forName("com.splicemachine.db.jdbc.EmbeddedXADataSource").newInstance());
            }
        }
