/*
   ...
   Derby - Class com.splicemachine.derbyBuild.propertyconfig
 ...
 * com.splicemachine.db.modules.properties
 *
 * <P>
...
public class propertyconfig {
					...
					throws IOException
	{
		...
		// copy this code from
		// com.splicemachine.db.impl.services.monitor.BaseMonitor
		//
					...
					if (moduleList.getProperty(envKey) != null)
					{
						...
						if (tag.endsWith("J1") || tag.endsWith("J2"))
						{
								...
								(moduleList.getProperty(alternateImplConfigKey) != null))
							{
								...
								// db.env.jdk.<tag>J2 and
								// db.env.jdk.<tag>J1 and
	...
	private static void printUsageAndExit()
	{
		...
		buf.append("Usage propertyConfig <masterFile> <config> <outputFile>\n")
			...
			.append("containing all the modules properties\n")
			.append("config must be a configuration defined in ")
			.append("com.splicemachine.db.modules.properties.\n")
