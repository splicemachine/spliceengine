/*
   ...
   Derby - Class com.splicemachine.db.client.am.Configuration
...
public class Configuration {
    ...
    public static int traceLevel__ = com.splicemachine.db.jdbc.ClientBaseDataSource.TRACE_ALL;
    ...
    private static final String packageNameForDNC = "com.splicemachine.db.client"; // NOTUSED
