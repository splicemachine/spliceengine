/*
   ...
   Derby - Class com.splicemachine.db.client.net.CcsidManager
...
public abstract class CcsidManager {
    ...
    public abstract byte[] convertFromJavaString(String sourceString, com.splicemachine.db.client.am.Agent agent) throws com.splicemachine.db.client.am.SqlException;
