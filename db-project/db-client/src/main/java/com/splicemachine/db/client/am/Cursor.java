/*
   ...
   Derby - Class com.splicemachine.db.client.am.Cursor
...
public abstract class Cursor {
    ...
    protected final int get_INTEGER(int column) {
        return com.splicemachine.db.client.am.SignedBinary.getInt(dataBuffer_,
                columnDataPosition_[column - 1]);
    }
    ...
    private final java.sql.Timestamp getTIMESTAMP(int column, Calendar cal)
        ...
        try {
            return com.splicemachine.db.client.am.DateTime.timestampBytesToTimestamp(
                dataBuffer_,
                columnDataPosition_[column - 1],
                cal,
                charsetName_[column - 1],
