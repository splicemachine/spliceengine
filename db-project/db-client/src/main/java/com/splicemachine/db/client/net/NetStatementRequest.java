/*
   ...
   Derby - Class com.splicemachine.db.client.net.NetStatementRequest
...
/*
  public void writeSetGenericSQLSetInfo (com.splicemachine.db.client.am.SetGenericSQLSetPiggybackCommand setGenericSQLSetPiggybackCommand,
                                  com.splicemachine.db.client.am.JDBCSection section) throws SqlException
  {
...
/////////// perf end
            ...
            if (extdtaPositions_ != null) {
                ...
                for (int i = 0; i < extdtaPositions_.size(); i++) {
                    ...
                    if (parameterType == Types.BLOB
                        ...
                        boolean isExternalBlob = !(b instanceof com.splicemachine.db.client.am.Blob);
                        if (isExternalBlob) {
                            try {
    ...
    private int checkFetchsize(int fetchSize, int resultSetType) {
        ...
        if (resultSetType != java.sql.ResultSet.TYPE_FORWARD_ONLY && fetchSize == 0) {
            fetchSize = com.splicemachine.db.client.am.Configuration.defaultFetchSize;
        }
        return fetchSize;
    }
