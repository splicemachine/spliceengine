/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.conglomerate.OpenConglomerateScratchSpace
    ...
    implements DynamicCompiledOpenConglomInfo
{
     ...
     * 
     * @see com.splicemachine.db.iapi.store.access.ConglomerateController#delete
     * @see com.splicemachine.db.iapi.store.access.ConglomerateController#replace
     */
