/*
   ...
   Derby - Class com.splicemachine.db.iapi.services.io.DynamicByteArrayOutputStream
...
public class DynamicByteArrayOutputStream extends OutputStream {
	...
	void writeCompleteStream(InputStream dataIn, int len) throws IOException
	{
		...
		com.splicemachine.db.iapi.services.io.InputStreamUtil.readFully(dataIn, buf, position, len);
		position += len;
