/* 
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.harness.RunList
...
public class RunList
{
        ...
        FileNotFoundException, IOException, Exception
    {
        ...
        for (int i = 0; i < suitesToRun.size(); i++)
        {
            ...
            */
            ...
            InputStream is =  com.splicemachine.dbTesting.functionTests.harness.RunTest.loadTestResource(runfile);
            if (is == null)
            {
                // Look in userdir
                is = com.splicemachine.dbTesting.functionTests.harness.RunTest.loadTestResource(userdir + '/' + suiteName + ".runall");
            }
            if (is == null)
            {
        ...
        while ( (str = runlistFile.readLine()) != null )
        {
            ...
            else
            {
                ...
                if ( ijdefaultResourcePackage != null )
                    ...
                    args[1] = "/com/splicemachine/dbTesting/functionTests/";
                if ( usesystem != null )
                    args[2] = usesystem;
                else
                    args[2] = "";
                ...
                args[5] = suite;
                args[6] = framework;
                com.splicemachine.dbTesting.functionTests.harness.RunTest.main(args);
    ...
    */
        ...
        throws ClassNotFoundException, IOException, Exception
    {
        ...
        InputStream is = com.splicemachine.dbTesting.functionTests.harness.RunTest.loadTestResource(suitePropsName);
        if (is == null)
        {
            // Look in userdir
            suitePropsName = userdir + '/' + suiteName + ".properties";
            is = com.splicemachine.dbTesting.functionTests.harness.RunTest.loadTestResource(suitePropsName);
        }
