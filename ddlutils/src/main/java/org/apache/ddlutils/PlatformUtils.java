...
//        jdbcDriverToPlatform.put(PlatformUtils.JDBC_DRIVER_INET_SYBASE,           SybasePlatform.DATABASENAME);
        ...
        jdbcSubProtocolToPlatform.put(SplicePlatform.JDBC_SUBPROTOCOL, SplicePlatform.DATABASENAME);
        jdbcDriverToPlatform.put(SplicePlatform.JDBC_DRIVER_EMBEDDED, SplicePlatform.DATABASENAME);
        jdbcDriverToPlatform.put(SplicePlatform.JDBC_DRIVER, SplicePlatform.DATABASENAME);
    }
     ...
     * @return The database type or <code>null</code> if the database type couldn't be determined
     */
    public String determineDatabaseType(DataSource dataSource, String username, String password) throws
