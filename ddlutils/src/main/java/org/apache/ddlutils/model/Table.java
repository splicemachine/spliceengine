...
public class Table implements Serializable {
     ...
     */
    private String _viewDefinition = null;
    /**
     * A description of the table.
     */
    private String _description = null;
    /**
     * The full file path the exported table contents.
     */
    private String _exportPath = null;
    /**
     * The table's type as read from the database.
     */
    private TableType _type = null;
    /**
    ...
    /**
     * Get the export path for the content of this table.<br/>
     * Used only by data export.
     *
     * @return the fully-qualified path where the export content will be located.
     */
    ...
    /**
     * Set the export path for the content of this table.<br/>
     * Used only by data export.
     *
     * @param exportPath the fully-qualified path where the export content will be located.
     */
    ...
    public String getQualifiedName() {
        return (_schema != null ? _schema.getSchemaName() + "." : "") + _name;
    }
    ...
    /**
     * Returns the SQL string used to construct this view. Only valid if this type is a {@link TableType#VIEW}
    ...
    /**
     * Record the SQL that was used to create this view.
     * @param viewDefinition view definition SQL
     */
