...
public class PipelineTest{
    ...
    private static ExecRow execRow;
    ...
    public void insertSingleRecord() throws Exception{
        ...
        try(RecordingCallBuffer<KVPair> callBuffer=writeCoordinator.synchronousWriteBuffer(partitionFactory.getTable(DESTINATION_TABLE_BYTES),txn, execRow)){
    ...
    public void writeWriteConflict() throws Exception{
        ...
        try(RecordingCallBuffer<KVPair> callBuffer=writeCoordinator.synchronousWriteBuffer(partitionFactory.getTable(DESTINATION_TABLE_BYTES),txn1,execRow)){
        ...
        try(RecordingCallBuffer<KVPair> callBuffer=writeCoordinator.synchronousWriteBuffer(partitionFactory.getTable(DESTINATION_TABLE_BYTES),txn2,execRow)){
