...
public class BulkWriteAction implements Callable<WriteStats>{
    private static final Logger LOG=LogManager.getLogger(BulkWriteAction.class);
    private static final Logger RETRY_LOG=LogManager.getLogger(BulkWriteAction.class.getName()+".retries");
