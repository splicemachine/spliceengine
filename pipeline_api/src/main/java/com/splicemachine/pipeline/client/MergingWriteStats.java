...
public class MergingWriteStats implements WriteStats{
		...
		public String toString() {
			return String.format("MergingWritesStats { bytesWrittenCounter=%d, rowsWrittenCounter=%d, " +
		"retryCounter=%d, globalErrorCounter=%d, partialFailureCounter=%d, rejectedCounter=%d, networkTimeView={%s}, " + 
		"sleepTimeView={%s}, totalTimeView={%s}",bytesWrittenCounter.getTotal(), rowsWrittenCounter.getTotal(),
		retryCounter.getTotal(), globalErrorCounter.getTotal(), partialFailureCounter.getTotal(), rejectedCounter.getTotal(),
		networkTimeView, sleepTimeView, totalTimeView);
		}
