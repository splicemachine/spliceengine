...
public class SavepointsTest {
    ...
    public void testRollbackWithSomePersistedTxns() throws Exception{
        ...
        Assert.assertEquals("joe9 absent", testUtility.read(t1.getTxn(), "joe9"));
        testUtility.insertAge(t1.getTxn(), "joe9", 20);
        Assert.assertEquals("joe9 age=20 job=null", testUtility.read(t1.getTxn(), "joe9"));
        ...
        testUtility.insertAge(t1.getTxn(), "joe9", 30);
        Assert.assertEquals("joe9 age=30 job=null", testUtility.read(t1.getTxn(), "joe9"));
