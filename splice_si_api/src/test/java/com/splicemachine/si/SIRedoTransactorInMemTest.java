...
public class SIRedoTransactorInMemTest {
    ...
    private RedoTransactorTestUtility testUtility;
    ...
    private void baseSetUp() {
        ...
        testUtility = new RedoTransactorTestUtility(useSimple,testEnv, transactorSetup);
