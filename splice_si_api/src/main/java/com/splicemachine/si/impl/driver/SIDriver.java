...
public class SIDriver {
    ...
    private Cache<Long, Cache<String, CachedReferenceCountedPartition>> regionCache;
    ...
    public Cache<Long, Cache<String, CachedReferenceCountedPartition>> getRegionCache() {
        return regionCache;
    }

    private Cache<Long, Cache<String, CachedReferenceCountedPartition>> createRegionCache() {

        Cache<Long, Cache<String, CachedReferenceCountedPartition>> cache = CacheBuilder.newBuilder()
