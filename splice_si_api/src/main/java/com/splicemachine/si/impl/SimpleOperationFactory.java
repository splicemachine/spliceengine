...
import static com.splicemachine.si.constants.SIConstants.SI_DELETE_PUT;
...
import static com.splicemachine.si.constants.SIConstants.TRUE_BYTES;
import static com.splicemachine.si.constants.SIConstants.EMPTY_BYTE_ARRAY;
...
import static com.splicemachine.si.constants.SIConstants.SI_EXEMPT;
import static com.splicemachine.si.constants.SIConstants.SI_NEEDED;
import static com.splicemachine.si.constants.SIConstants.SI_COUNT_STAR;
 ...
 * Date: 7/8/14
 */
public class SimpleOperationFactory<OperationWithAttributes,Data,Delete extends OperationWithAttributes,Filter,Get extends OperationWithAttributes,Mutation extends OperationWithAttributes,
        Put extends OperationWithAttributes,RegionScanner,Result,ReturnCode,Scan extends OperationWithAttributes> implements TxnOperationFactory<OperationWithAttributes,Delete,Get,Mutation,Put,Scan> {
    ...
    public SimpleOperationFactory() {}
		...
		public Put newPut(TxnView txn,byte[] rowKey) throws IOException {
            ...
            if(!txn.allowsWrites())
                throw exceptionLib.getReadOnlyModificationException("transaction is read only: "+ txn.getTxnId());
