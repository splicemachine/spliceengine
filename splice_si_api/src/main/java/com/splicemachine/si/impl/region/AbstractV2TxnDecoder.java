...
public abstract class AbstractV2TxnDecoder<OperationWithAttributes, Data,Delete extends OperationWithAttributes,Filter,Get extends OperationWithAttributes,
        KVPair,Put extends OperationWithAttributes,RegionScanner,Result,ReturnCode,Scan extends OperationWithAttributes,Transaction,TxnInfo> implements TxnDecoder<OperationWithAttributes,Data,Delete,Filter,
        Get,Put,RegionScanner,Result,
        Scan,Transaction,TxnInfo> {
    ...
    protected long toLong(SDataLib<OperationWithAttributes,Data,Delete,Filter,Get,
            Put,RegionScanner,Result,Scan> dataLib, Data data) {
    	return Encoding.decodeLong(dataLib.getDataValueBuffer(data), dataLib.getDataValueOffset(data), false);
    }
        
    protected Transaction decodeInternal(SDataLib<OperationWithAttributes,Data,Delete,Filter,Get,
            Put,RegionScanner,Result,Scan> dataLib,
                                         Data dataKv, Data keepAliveKv, Data commitKv, Data globalCommitKv,
                                         Data stateKv, Data destinationTables, long txnId) {
