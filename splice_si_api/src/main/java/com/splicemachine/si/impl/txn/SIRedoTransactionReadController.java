 ...
 *         Date: 2/13/14
 */
public class SIRedoTransactionReadController implements TransactionReadController{
    private final TxnSupplier txnSupplier;

    public SIRedoTransactionReadController(TxnSupplier txnSupplier){
    ...
    public TxnFilter newFilterState(ReadResolver readResolver,TxnView txn) throws IOException{
        return new SimpleActiveTxnFilter(txn,readResolver,txnSupplier);
    }
