...
public class SimpleTxnFilter<OperationWithAttributes,Data,Delete extends OperationWithAttributes,Filter,
        ...
        Put extends OperationWithAttributes,RegionScanner,Result,ReturnCode,RowLock,Scan extends OperationWithAttributes,Table> implements TxnFilter<Data,ReturnCode> {
    	private final TxnSupplier transactionStore = new ActiveTxnCacheSupplier(SIDriver.getTxnSupplier(),1000); // JL-TODO
        ...
        private final ActiveIgnoreTxnCacheSupplier ignoreTxnCache = new ActiveIgnoreTxnCacheSupplier(SIDriver.getIgnoreTxnCacheSupplier());
    ...
    private ReturnCode checkVisibility(Data data) throws IOException {
				/*
				...
				if(!isVisible(timestamp)) return returnCodeLib.getSkipReturnCode();
