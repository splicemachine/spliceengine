 ...
 * Date: 2/13/14
 */
public interface TransactionReadController<Data,Filter,Get,Result,ReturnCode,Scan> {
		 ...
		 */
		Result filterResult(TxnFilter<Data,ReturnCode> filterState, Result result) throws IOException;
