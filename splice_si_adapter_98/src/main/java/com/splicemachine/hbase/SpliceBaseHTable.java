...
public abstract class SpliceBaseHTable implements HTableInterface, TableRegionsInRange {
    ...
    public SpliceBaseHTable(byte[] tableName, Configuration configuration, boolean retryAutomatically) throws IOException{
    ...
    private void wait(int attemptCount) {
        try {
            ...
            Logger.getLogger(SpliceBaseHTable.class).info("Interrupted while sleeping");
        }
    }
