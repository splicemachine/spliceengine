/*
   ...
   Derby - Class com.splicemachine.dbTesting.unitTests.junit.SystemPrivilegesPermissionTest
...
package com.splicemachine.dbTesting.unitTests.junit;
...
public class SystemPrivilegesPermissionTest extends BaseTestCase {
    ...
    static private String POLICY_FILE_NAME
        = "com/splicemachine/dbTesting/unitTests/junit/SystemPrivilegesPermissionTest.policy";

    /**
     * The policy file name for the DatabasePermission API test.
     */
    static private String POLICY_FILE_NAME1
        = "com/splicemachine/dbTesting/unitTests/junit/SystemPrivilegesPermissionTest1.policy";
