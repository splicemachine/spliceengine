/*
 *
 * Derby - Class com.splicemachine.dbTesting.junit.Utilities
 *
...
public class Utilities {
    ...
    public static String formatTestClassNames(String test) {
        final String COMMON_FUNCTIONTEST_PREFIX = "com.splicemachine.dbTesting.functionTests.tests.";
        final String COMMON_TEST_PREFIX = "com.splicemachine.dbTesting.";
