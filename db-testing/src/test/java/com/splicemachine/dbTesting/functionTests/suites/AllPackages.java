/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.suites.AllPackages
...
import com.splicemachine.dbTesting.functionTests.tests.replicationTests.ReplicationSuite;
...
public class AllPackages extends BaseTestCase {
    ...
    private static List getTestClasses() {
        ...
        classes.add(com.splicemachine.dbTesting.functionTests.tests.derbynet._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.lang._Suite.class);
        // DERBY-1903
        // For the largedata test, just run the lite version of the test as
        // the full test is too big.
        classes.add(
             com.splicemachine.dbTesting.functionTests.tests.largedata.LobLimitsLiteTest.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.jdbcapi._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.store._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.tools._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.engine._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.memory._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.memorydb._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.i18n._Suite.class);
        classes.add(com.splicemachine.dbTesting.functionTests.tests.multi.StressMultiTest.class);

        // Suites that are compiled using Java SE 6 target need to
        // be added this way, otherwise creating the suite
        // will throw an invalid class version error
        classes.add("com.splicemachine.dbTesting.functionTests.tests.jdbc4._Suite");
        
        // JMX management tests are compiled and require JDK 1.5
        classes.add("com.splicemachine.dbTesting.functionTests.tests.management._Suite");

        // Adding JUnit unit tests here to avoid creating a new JUnit
        // harness above the functionTests and unitTests
        // directories(packages)
        classes.add(com.splicemachine.dbTesting.unitTests.junit._Suite.class);
        ...
        classes.add(
           com.splicemachine.dbTesting.functionTests.tests.upgradeTests._Suite.class);
