...
Derby - Class com.splicemachine.dbTesting.functionTests.tests.replicationTests.ReplicationTestRun
...
public class ReplicationTestRun extends BaseJDBCTestCase
{
        ...
        throws Exception
    {
         ...
         */
        /* 
        suite.addTest(com.splicemachine.dbTesting.functionTests.suites.All.replSuite());
         */
