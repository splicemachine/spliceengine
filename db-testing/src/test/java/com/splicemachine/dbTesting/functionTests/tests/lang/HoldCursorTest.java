/* Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.HoldCursorTest
 *
...
public class HoldCursorTest extends BaseJDBCTestCase {
	...
	protected void setUp() throws SQLException {
	    ...
	    stmt.execute("create procedure MYPROC() language java parameter style java external name " +
	    				"'com.splicemachine.dbTesting.functionTests.tests.lang.HoldCursorTest.testProc' result sets 2");
