/*
 *
 * Derby - Class com.splicemachine.dbTesting.functionTests.tests.jdbcapi/SavepointJdbc30Test
 *
...
public class SavepointJdbc30Test extends BaseJDBCTestCase {
     ...
     * com.splicemachine.dbTesting.functionTests.tests.jdbcapi.savepointJdbc30::doConnectionSetSavepointUnnamed()");
     * try {
     * 
     ...
     * for each statement call
     * com.splicemachine.dbTesting.functionTests.tests.jdbcapi.savepointJdbc30::doConnectionSetSavepointNamed()");
     ...
     * each statement call
     * com.splicemachine.dbTesting.functionTests.tests.jdbcapi.savepointJdbc30::doConnectionReleaseSavepoint()");
     * try { s.executeUpdate("insert into t1 values(1,1)");
     ...
     * each statement call
     * com.splicemachine.dbTesting.functionTests.tests.jdbcapi.savepointJdbc30::doConnectionRollbackSavepoint()");
     * try { s.executeUpdate("insert into t1 values(1,1)");
