/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.jdbcapi.SetQueryTimeoutTest
...
public class SetQueryTimeoutTest
{
            ...
            TestFailedException
    {
        ...
        exec(conn, "CREATE FUNCTION DELAY(SECONDS INTEGER, VALUE INTEGER) RETURNS INTEGER PARAMETER STYLE JAVA NO SQL LANGUAGE JAVA EXTERNAL NAME 'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.SetQueryTimeoutTest.delay'");
