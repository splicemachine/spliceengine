/*
 *
 * Derby - Classs com.splicemachine.dbTesting.functionTests.tests.jdbcapi.PrepStmtMetaDataTest
 *
    ...
    public void testNoResultSetMeta() throws SQLException {
        ...
        s
                .execute("create procedure testproc() language java external name "
                        + "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.PrepStmtMetaDataTest.tstmeth'"
