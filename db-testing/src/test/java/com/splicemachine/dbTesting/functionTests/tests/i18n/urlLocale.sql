...
create procedure checkDatabaseLoc(in locale char(12)) parameter style java language java external name 'com.splicemachine.dbTesting.functionTests.tests.i18n.DefaultLocale.checkDatabaseLocale';
create procedure checkRDefaultLoc() parameter style java language java external name 'com.splicemachine.dbTesting.functionTests.tests.i18n.DefaultLocale.checkRDefaultLocale';
