...
--
disconnect;
connect 'jdbc:splice:detest;create=true;';
connect 'jdbc:splice:detest;create=true;' as M�nchen;
...
insert into detab values(23.123,date('2000-11-03'),'Die maximale Gr��e f�r Varchar mu� zwischen 1 und 255 liegen.');
