...
Derby - Class com.splicemachine.dbTesting.functionTests.tests.jdbcapi.ParameterMetaDataJdbc30Test
	...
	private static Test baseSuite(String name)
    	{
			 ...
			 *
                ...
                stmt.execute(
                    ...
                    "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi." +
	...
	* @exception SQLException if error occurs
	...
	public void testBooleanParameters() throws SQLException
    {
        ...
        stmt.executeUpdate
            (
             ...
             "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.BooleanValuesTest.booleanValue'\n"
             );
        stmt.executeUpdate
            (
	...
	public void testCallableStatementReturnedScale () throws SQLException {
		...
		if (!usingDerbyNetClient()) {
			Statement stmt = createStatement();
      			stmt.executeUpdate("create procedure dummy_numeric_Proc(out a NUMERIC(30,15), out b NUMERIC(30,15)) language java parameter style java external name 'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.ParameterMetaDataJdbc30Test.dummy_numeric_Proc'");
	...
	public void testMetatdataAfterProcRecompile () throws SQLException {
		...
		if (!usingDerbyNetClient()) {
      			...
      			stmt.executeUpdate("create procedure dummyint(in a integer, in b integer, out c integer, inout d integer) language java external name 'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.ParameterMetaDataJdbc30Test.dummyint2' parameter style java");
      			cs.execute();
    ...
    {
        Statement stmt = createStatement();
        stmt.execute("CREATE PROCEDURE PMDT(IN pmdI_1 TIMESTAMP, INOUT pmdI_2 TIMESTAMP, OUT pmdI_3 TIMESTAMP) language java parameter style java external name 'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.ParameterMetaDataJdbc30Test.dummyString'");
