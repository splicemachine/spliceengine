/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.UDTTest
...
public class UDTTest  extends GeneratedColumnsHelper
{
    ...
    public void test_02_basicColumnRetvalParam() throws Exception
    {
        ...
        goodStatement( conn, "create type Price external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        ...
        goodStatement
            ( conn,
              ...
              "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price.getCurrencyCode'\n" );
        goodStatement
            ( conn,
              "create function getAmount( price Price ) returns decimal( 31, 5 ) language java parameter style java no sql\n" +
              "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price.getAmount'\n" );
        goodStatement
            ( conn,
              "create function getTimeInstant( price Price ) returns timestamp language java parameter style java no sql\n" +
              "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price.getTimeInstant'\n" );
        goodStatement
            ( conn,
              "create procedure savePrice( in a Price ) language java parameter style java no sql\n" +
              "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price.savePrice'\n" );
        goodStatement
            ( conn,
              "create function getSavedPrice() returns Price language java parameter style java no sql\n" +
              "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price.getSavedPrice'\n" );
        goodStatement
            ( conn,
    ...
    public void test_03_addDropColumn() throws Exception
    {
        ...
        goodStatement
            ( conn,
              "create type price_03 external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        ...
        goodStatement
            ( conn,
              "create type price_03_a external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        goodStatement
            ( conn,
              "create type price_03_b external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        goodStatement
            ( conn,
              "create type price_03_c external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
    ...
    public void test_04_dropTable() throws Exception
    {
        ...
        goodStatement
            ( conn,
              "create type price_orphan external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        goodStatement
            ( conn,
              "create type price_orphan2 external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        goodStatement
            ( conn,
              "create type price_orphan3 external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        goodStatement
            ( conn,
              "create type price_orphan4 external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        goodStatement
            ( conn,
    ...
    public void test_05_viewDependencies() throws Exception
    {
        ...
        createTypeStatement = "create type price_05_a external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
        ...
        createTypeStatement = "create type price_05_b external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
    ...
    public void test_07_routineDependencies() throws Exception
    {
        ...
        createTypeStatement = "create type price_07_a external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
        ...
        createTypeStatement = "create type price_07_b external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
        ...
        createTypeStatement = "create type price_07_c external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
        ...
        createObjectStatement = 
            ...
            "parameter style java\n" +
            "no sql\n" +
            "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.UDTTest.oneArgPriceProc_07'\n";
        ...
        createTypeStatement = "create type price_07_d external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
        ...
        createObjectStatement = 
            ...
            "parameter style java\n" +
            "no sql\n" +
            "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.UDTTest.twoArgPriceProc_07'\n";
        ...
        createObjectStatement = 
            ...
            "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.UDTTest.hashmapReader'\n";
    ...
    public void test_08_triggerDependencies() throws Exception
    {
        ...
        createTypeStatement = "create type price_08_a external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n";
    ...
    public void test_09_resultSetMetaData() throws Exception
    {
        ...
        goodStatement( conn, "create type price_09_a external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
        ...
        checkRSMD
            (
             ...
             "com.splicemachine.dbTesting.functionTests.tests.lang.Price",
             15,
    ...
    public void test_10_parameterMetaData() throws Exception
    {
        ...
        goodStatement( conn, "create type price_10_a external name 'com.splicemachine.dbTesting.functionTests.tests.lang.Price' language java\n" );
    ...
    public void test_11_tableFunctionColumns() throws Exception
    {
        ...
        goodStatement
            (
             ...
             "language java parameter style java no sql\n" +
             "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.UDTTest.putValue'\n"
             );
    ...
    public void test_12_largeUDTs() throws Exception
    {
        ...
        //
        goodStatement( conn, "create type IntArray external name 'com.splicemachine.dbTesting.functionTests.tests.lang.IntArray' language java\n" );
        goodStatement
            ( conn,
              "create function makeIntArray( arrayLength int ) returns IntArray\n" +
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.IntArray.makeIntArray'\n" );
        goodStatement
            ( conn,
              "create function setCell( array IntArray, cellNumber int, cellValue int ) returns IntArray\n" +
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.IntArray.setCell'\n" );
        goodStatement
            ( conn,
              "create function getCell( array IntArray, cellNumber int ) returns int\n" +
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.IntArray.getCell'\n" );
        ...
        //
        goodStatement( conn, "create type FakeByteArray external name 'com.splicemachine.dbTesting.functionTests.tests.lang.FakeByteArray' language java\n" );
        goodStatement
            ( conn,
              "create function makeFakeByteArray( l int, f int ) returns FakeByteArray\n" +
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.FakeByteArray.makeFakeByteArray'\n" );
        goodStatement
            ( conn,
              "create function toString( arg FakeByteArray ) returns varchar( 30 )\n" +
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.FakeByteArray.toString'\n" );
    ...
    public void test_13_sqlData() throws Exception
    {
        ...
        goodStatement( conn, "create type SampleSQLData external name 'com.splicemachine.dbTesting.functionTests.tests.lang.SampleSQLData' language java\n" );
        goodStatement
            ( conn,
              "create function makeSampleSQLData( l int ) returns SampleSQLData\n" +
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.SampleSQLData.makeSampleSQLData'\n" );
    ...
    public void test_15_ordering() throws Exception
    {
        ...
        goodStatement( conn, "create type IntArray_15 external name 'com.splicemachine.dbTesting.functionTests.tests.lang.IntArray' language java\n" );
        goodStatement
            ( conn,
    ...
    public void test_16_casts() throws Exception
    {
        ...
        goodStatement
            ( conn,
              ...
              "language java parameter style java no sql external name 'com.splicemachine.dbTesting.functionTests.tests.lang.UDTTest.makeNumber'\n" );
