/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.jdbc4.CallableStatementTest
    ...
    public  void    testJDBC4_1() throws Exception
    {
        ...
        PreparedStatement   ps = prepareStatement
            (
             ...
             "no sql\n" +
             "external name 'com.splicemachine.dbTesting.functionTests.tests.jdbc4.CallableStatementTest.allTypesProc'\n"
             );
        ps.execute();
        ps.close();
    ...
    public  void    test_4959() throws Exception
    {
        ...
        PreparedStatement   ps = prepareStatement
            (
             ...
             "parameter style java\n" +
             "no sql\n" +
             "external name 'com.splicemachine.dbTesting.functionTests.tests.jdbc4.CallableStatementTest.blobProc'\n"
             );
        ps.execute();
        ps.close();
        ps = prepareStatement
            (
             ...
             "parameter style java\n" +
             "no sql\n" +
             "external name 'com.splicemachine.dbTesting.functionTests.tests.jdbc4.CallableStatementTest.clobProc'\n"
             );
        ps.execute();
        ps.close();
