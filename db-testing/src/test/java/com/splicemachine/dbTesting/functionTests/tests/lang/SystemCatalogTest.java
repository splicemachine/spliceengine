...
Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.SystemCatalogTest
...
public class SystemCatalogTest extends BaseJDBCTestCase {
	...
	public void testSystemCatalogStoreProperties() throws SQLException{
		Statement s = createStatement();
		s.execute("create function gatp(SCH VARCHAR(128), TBL VARCHAR(128)) RETURNS VARCHAR(1000) EXTERNAL NAME 'com.splicemachine.dbTesting.functionTests.util.TestPropertyInfo.getAllTableProperties' LANGUAGE JAVA PARAMETER STYLE JAVA");
		s.execute("create function gaip(SCH VARCHAR(128), TBL VARCHAR(128)) RETURNS VARCHAR(1000) EXTERNAL NAME 'com.splicemachine.dbTesting.functionTests.util.TestPropertyInfo.getAllIndexProperties' LANGUAGE JAVA PARAMETER STYLE JAVA");
