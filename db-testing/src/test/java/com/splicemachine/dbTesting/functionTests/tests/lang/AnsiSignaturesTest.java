/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.AnsiSignaturesTest
        ...
        throws Exception
    {
        ...
        PreparedStatement   ps = conn.prepareStatement
            (
             ...
             "no sql\n" +
             "external name 'com.splicemachine.dbTesting.functionTests.tests.lang.AnsiSignatures.wrapperProc'\n"
             );
        ps.execute();
        ps.close();
