/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.WISCInsert
...
public class WISCInsert {
	...
	{
		StringBuffer st = new StringBuffer(getShortTestDescription() +"\n Called from performance.wisc.WiscLoad. This is not actually a test itself. Based on a scale value by which to multiply the number of rows, the values are generated. This class is based on the vti com.splicemachine.dbTesting.functionTests.tests.lang.Wisc, however, this will work with any database, not just Cloudscape.");
		return st.toString();
