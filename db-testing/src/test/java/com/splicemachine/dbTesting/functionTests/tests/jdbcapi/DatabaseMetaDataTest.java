/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.jdbcapi.DatabaseMetaDataTest
...
public class DatabaseMetaDataTest extends BaseJDBCTestCase {
    ...
    */
    ...
    public void testUDTs() throws Exception
    {
        ...
        {
            {  null, schema, "PRICE", "com.splicemachine.dbTesting.functionTests.tests.lang.Price", "2000", null, null },
        };
    ...
    */
    ...
    public void testGetProceduresGetProcColumns() throws Exception {
        ...
        s.execute("create procedure GETPCTEST1 (" +
                ...
                "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.DatabaseMetaDataTest.getpc'" +
        ...
        s.execute("create procedure GETPCTEST4A()  "+
                "language java external name " +
                "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.DatabaseMetaDataTest.getpc4a'"+
        " parameter style java"); 
        s.execute("create procedure GETPCTEST4B() "+
                "language java external name " +
                "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.DatabaseMetaDataTest.getpc4b'" +
        " parameter style java"); 
        ...
        if ( supportsBoolean )
        {
            s.execute("create procedure GETPCTEST5(in inarg boolean, out outarg boolean, inout inoutarg boolean) "+
                      "language java external name " +
                      "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.DatabaseMetaDataTest.foo'" +
                      " parameter style java");
        }
    ...
    public void testGetFunctionColumns() throws Exception
    {
        ...
        s.execute("create function f_gfc_1 (" +
                ...
                "language java external name " +
                "'com.splicemachine.dbTesting.BlahBlah.blah'" +
        " parameter style java"); 
        ...
        if ( supportsBoolean )
        {
            s.execute("create function f_gfc_2 ( a boolean) returns boolean "+
                      "language java external name " +
                      "'com.splicemachine.dbTesting.functionTests.BlahBlah.blah'" +
                      " parameter style java");
        }
    ...
    public void testBugFixes() throws SQLException {
        ...
        if(JDBC.vmSupportsJDBC3()){
            s.execute("create procedure isReadO() language java external name " +
                    "'com.splicemachine.dbTesting.functionTests.tests.jdbcapi.DatabaseMetaDataTest.isro'" +
            " parameter style java"); 
