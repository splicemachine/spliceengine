/*
 * 
 * Derby - Class com.splicemachine.dbTesting.system.oe.run.Populate
 * 
...
import com.splicemachine.dbTesting.junit.JDBCPerfTestCase;
import com.splicemachine.dbTesting.system.oe.client.Load;
import com.splicemachine.dbTesting.system.oe.load.ThreadInsert;

/**
 * Driver to do the load phase for the Order Entry benchmark.
 * 
 * This class takes in following arguments currently:
 * Usage: java com.splicemachine.dbTesting.system.oe.run.Populate options
 * Options:
 * <OL>
 ...
 * <BR>
 * java com.splicemachine.dbTesting.system.oe.run.Populate -scale 2 -doChecks false -createConstraintsBeforeLoad false
 * <BR>
...
public class Populate extends JDBCPerfTestCase {
    ...
    {
        parseArgs(args);
        String[] tmp= {"com.splicemachine.dbTesting.system.oe.run.Populate"};
    ...
    private static void printUsage() {
        System.out.println("Usage: java com.splicemachine.dbTesting.system.oe.run.Populate options");
        System.out.println();
    ...
    public void testLoad() throws Exception {
        ...
        // of com.splicemachine.dbTesting.system.oe.client.Load can be used
