...
PACKAGING:
==========
The test resides under the com.splicemachine.dbTesting.systen.nstest package. The main
class to invoke is com.splicemachine.dbTesting.system.nstest.NsTest. Currently all the
...
===========
Usage:
java com.splicemachine.dbTesting.system.nstest.NsTest DerbyClient|Embedded [small]

The main class to invoke is com.splicemachine.dbTesting.system.nstest.NsTest. This class
...
SETTINGS:
=========
Almost all the variable settings for this test reside in the com.splicemachine.dbTesting.system.nstest.NsTest
