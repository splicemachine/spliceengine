...
public class PipelineConfiguration implements ConfigurationDefault {
    ...
    public static final String SPARK_RESULT_STREAMING_TIMEOUT = "spark.result.streaming.timeoutInSeconds";
    public static final int DEFAULT_SPARK_RESULT_STREAMING_TIMEOUT = 60;
    ...
    public void setDefaults(ConfigurationBuilder builder, ConfigurationSource configurationSource) {
        ...
        builder.sparkResultStreamingTimeout = configurationSource.getInt(SPARK_RESULT_STREAMING_TIMEOUT, DEFAULT_SPARK_RESULT_STREAMING_TIMEOUT);
