...
public class UnsafeRecordTest {
    ...
    @Test
    public void testTxnID2Mutability() throws Exception {
        TEST_RECORD.setTxnId2(123456l);
        Assert.assertEquals("Transaction Id1 Not Set",TEST_RECORD.getTxnId2(),123456l);
        TEST_RECORD.setTxnId2(123l);
        Assert.assertEquals("Transaction Id1 Not Set",TEST_RECORD.getTxnId2(),123l);
    }
    ...
    public void testRecordToString() {
        ...
        Assert.assertEquals("Display is not accurate","UnsafeRecord {key=726f776b6579313234, version=2, " +
                "tombstone=true, txnId1=123456, txnId2=123456, effectiveTimestamp=123456, numberOfColumns=123}",record.toString());
    }
