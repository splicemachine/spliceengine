 ...
 * call SYSCS_UTIL.SYSCS_SET_LOGGER_LEVEL('com.splicemachine.db.impl.ast.PlanDebugger', 'TRACE');
 *
 * @author Yifu Ma
 */
public class PlanDebugger extends AbstractSpliceVisitor {
    ...
    private void pushExplain(ResultSetNode rsn,ExplainTree.Builder builder) throws StandardException{
        ...
        if(rsn instanceof FromBaseTable){
            ...
            builder.addBaseTable(rsNum,null,tableName,indexName,qualifiers,fbt.isMultiProbing(),fbt.isDistinctScan());
            ...
            builder.addBaseTable(rsNum,null,"VTI:"+tableName,null,null,false,false);
        }
