/*
   ...
   Derby - Class com.splicemachine.db.impl.store.raw.data.FileContainer
...
import com.splicemachine.db.iapi.util.InterruptDetectedException;
    ...
    extends BaseContainer implements Cacheable, TypedFormat
{
		...
		if (onDiskChecksum != checksum.getValue())
		{
			...
			throw dataFactory.markCorrupt
				(StandardException.newException(
                    ...
                    com.splicemachine.db.iapi.util.StringUtil.hexDump(a)));
		}
	...
	*/
		 ...
		 throws StandardException
	{
        ...
        // rollforward recovery or if db.storage.patchInitPageRecoverError
        // is set to true.
