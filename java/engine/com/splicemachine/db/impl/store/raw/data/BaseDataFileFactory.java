/*
   ...
   Derby - Class com.splicemachine.db.impl.store.raw.data.BaseDataFileFactory
    ...
    implements DataFactory, CacheableFactory, ModuleControl, ModuleSupportable, PrivilegedExceptionAction
{
	...
	*/
        ...
        throws StandardException 
    {
		...
		//Log db.system.home It will have null value if user didn't set it
		logMsg(Property.SYSTEM_HOME_PROPERTY+"=" + 
				PropertyUtil.getSystemProperty(Property.SYSTEM_HOME_PROPERTY));
		
		//Log properties related to redirection of db.log
		String target = 
        ...
        // If db.system.durability=test then set flags to disable sync of
            ...
            PropertyUtil.getSystemProperty(Property.DURABILITY_PROPERTY)))
        {
            ...
            // log message stating that db.system.durability
	...
	*/
     ...
     * <p>
     * The db write ahead log algorithm uses checkpoint of the data
	...
	*/
    ...
    private void privGetJBMSLockOnDB() throws StandardException
    {
        ...
        if (fileLock.delete())
        {
            ...
            //double booting of db databases. If we don't get a reliable
