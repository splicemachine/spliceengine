/*
   ...
   Derby - Class com.splicemachine.db.impl.store.raw.RawStore
...
package com.splicemachine.db.impl.store.raw;
...
import com.splicemachine.db.iapi.store.raw.ScanHandle;
...
import com.splicemachine.db.impl.services.monitor.UpdateServiceProperties;
...
public final class RawStore implements RawStoreFactory, ModuleControl, ModuleSupportable, PrivilegedExceptionAction
{
	...
	*/
		...
		throws StandardException
	{
		...
		DaemonFactory daemonFactory =
			(DaemonFactory)Monitor.startSystemModule(Module.DaemonFactory);
	...
	*/
    ...
    /**
     * @see com.splicemachine.db.iapi.store.raw.RawStoreFactory#failover(String dbname).
     */
        ...
        throws StandardException
	{
		...
		else
		{
            ...
            // mistake, backup path can not be a db database directory.
            // If a directory contains PersistentService.PROPERTIES_NAME, it 
            // is assumed to be a db database directory because db
