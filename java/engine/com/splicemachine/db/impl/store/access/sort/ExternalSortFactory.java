/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.sort.ExternalSortFactory
    ...
    SortFactory, ModuleControl, ModuleSupportable, SortCostController
{
	...
	**/
        ...
        throws StandardException
	{
		...
		if (!userSpecified)	
		{
			// db.storage.sortBufferMax is not specified by the
		...
		{
			// if user specified db.storage.sortBufferMax, use it.
				sortBufferMax = defaultSortBufferMax;
		}
