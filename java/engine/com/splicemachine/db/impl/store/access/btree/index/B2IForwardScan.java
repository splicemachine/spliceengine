/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.btree.index.B2IForwardScan
...
import com.splicemachine.db.impl.store.access.btree.BTreeForwardScan;
...
db only supports forward scans (but individual columns can have
