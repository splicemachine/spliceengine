/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.btree.BTree
...
public abstract class BTree extends GenericConglomerate
{
    ...
    or branch).  Equal to 'db.access.btreeMaxRowPerPage'.  Used by tests
	...
	**/
	...
	@see com.splicemachine.db.iapi.store.access.conglomerate.Conglomerate#drop
	...
	**/
	...
	@see com.splicemachine.db.iapi.store.access.conglomerate.Conglomerate#load
	...
	**/
	...
	This must be done by a concrete implementation.
	@see com.splicemachine.db.iapi.store.access.conglomerate.Conglomerate#open
