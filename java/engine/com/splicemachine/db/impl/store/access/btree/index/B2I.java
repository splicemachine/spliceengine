/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.btree.index.B2I
...
import com.splicemachine.db.impl.store.access.btree.BTreeLockingPolicy;
import com.splicemachine.db.impl.store.access.btree.LeafControlRow;
import com.splicemachine.db.impl.store.access.btree.OpenBTree;
...
/*
 * @db.formatId ACCESS_B2I_V3_ID
 *
 * @db.purpose   The tag that describes the on disk representation of the B2I
 ...
 *
 * @db.upgrade   The format id of this object is currently always read from disk
 ...
 *
 * @db.upgrade   This is the current version, no upgrade necessary.
 *
 * @db.diskLayout
 *     format_of_this_conlgomerate(byte[])
 *     containerid(long)
