/*
   ...
   Derby - Class
   com.splicemachine.db.impl.store.replication.slave.SlaveController
...
package com.splicemachine.db.impl.store.replication.slave;
...
import com.splicemachine.db.impl.store.raw.log.LogCounter;
import com.splicemachine.db.iapi.store.raw.log.LogFactory;
import com.splicemachine.db.impl.store.raw.log.LogToFile;
import com.splicemachine.db.impl.store.replication.net.SlaveAddress;

import com.splicemachine.db.impl.store.replication.ReplicationLogger;
import com.splicemachine.db.impl.store.replication.net.ReplicationMessage;
import com.splicemachine.db.impl.store.replication.net.ReplicationMessageReceive;
...
public class SlaveController
    ...
    /**
     * Write the reason for the lost connection to the log (db.log)
     ...
     *    db.log) if ReplicationLogger#LOG_REPLICATION_MESSAGES is
     *    true.
     *
