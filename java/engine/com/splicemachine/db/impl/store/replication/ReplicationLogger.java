/*
   ...
   Derby - Class
   com.splicemachine.db.impl.store.replication.ReplicationLogger
...
package com.splicemachine.db.impl.store.replication;
...
public class ReplicationLogger {
    ...
    /** Whether or not to print log messages to db.log. Defaults to
     * true, but can be set to false with db property
     ...
     * log (usually db.log) provided that verbose
    ...
    /**
     * Print a text to the log (usually db.log), provided that
     * verbose is true.
