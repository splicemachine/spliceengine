 ...
 */
class InsertResultSet extends DMLWriteResultSet implements TargetResultSet,HasIncrement
{
   ...
   * name in the list.
	...
	public DataValueDescriptor 
		increment(int columnPosition, long increment)
		throws StandardException 
	{
		return getSetAutoincrementValue(columnPosition, increment);
	}	
