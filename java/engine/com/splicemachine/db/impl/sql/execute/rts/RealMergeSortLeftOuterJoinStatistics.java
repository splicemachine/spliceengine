...
package com.splicemachine.db.impl.sql.execute.rts;

import com.splicemachine.db.iapi.sql.execute.ResultSetStatistics;
import com.splicemachine.db.catalog.UUID;
import com.splicemachine.db.impl.sql.catalog.XPLAINResultSetDescriptor;
import com.splicemachine.db.impl.sql.execute.xplain.XPLAINUtil;
...
*/
public class RealMergeSortLeftOuterJoinStatistics extends RealNestedLoopLeftOuterJoinStatistics
{
	 ...
	 *
	 */
    public	RealMergeSortLeftOuterJoinStatistics(
								int numOpens,
								int rowsSeen,
								int rowsFiltered,
