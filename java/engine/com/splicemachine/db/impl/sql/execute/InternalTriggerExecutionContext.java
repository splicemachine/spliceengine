...
public class InternalTriggerExecutionContext implements TriggerExecutionContext, ExecutionStmtValidator {
    ...
    */
    ...
    /**
     * aiCounters is a vector of AutoincrementCounters used to keep state which might be used by the trigger. This is
    ...
    /**
     * aiHT is a hashtable of autoincrement <key, value> pairs. This is used for ai values generated by the trigger.
     */
    ...
    public Long getAutoincrementValue(String identity) {
        ...
        if (aiCounters != null) {
            for (int i = 0; i < aiCounters.size(); i++) {
                AutoincrementCounter aic = aiCounters.elementAt(i);
