...
class VTIResultSet extends NoPutResultSetImpl
	...
	*/
	...
	public void	openCore() throws StandardException 
	{
		...
		try {
			if (version2)
			{
				...
				if (userPS instanceof com.splicemachine.db.vti.Pushable) {
					com.splicemachine.db.vti.Pushable p = (com.splicemachine.db.vti.Pushable) userPS;
					if (referencedColumns != null) {
						pushedProjection = p.pushProjection(this, getProjectedColList());
					}
				}

				if (userPS instanceof com.splicemachine.db.vti.IQualifyable) {
					com.splicemachine.db.vti.IQualifyable q = (com.splicemachine.db.vti.IQualifyable) userPS;
	...
	/**
     * @see com.splicemachine.db.iapi.sql.ResultSet#close
	 *
