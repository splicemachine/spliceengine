/*
   ...
   Derby - Class com.splicemachine.db.iapi.types.BigIntegerDecimal
...
public final class BigIntegerDecimal extends BinaryDecimal
{
	...
	/**
	 * Negate the number.
	 * @see com.splicemachine.db.iapi.types.NumberDataValue#minus(com.splicemachine.db.iapi.types.NumberDataValue)
	 */
	...
	/* (non-Javadoc)
	 * @see com.splicemachine.db.iapi.types.VariableSizeDataValue#setWidth(int, int, boolean)
	 */
