/*
   ...
   Derby - Class com.splicemachine.db.iapi.services.io.StoredFormatIds
...
public interface StoredFormatIds {
    ...
    */
    ...
    /**
        class com.splicemachine.db.impl.sql.execute.RunTimeStatisticsImpl
     */
    ...
    */
    ...
    /**
        class com.splicemachine.db.impl.sql.execute.RealProjectRestrictStatistics
     */
    static public final int REAL_PROJECT_RESTRICT_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 177);

    /**
        class com.splicemachine.db.impl.sql.execute.RealDistinctScalarAggregateStatistics
     */
    static public final int REAL_DISTINCT_SCALAR_AGGREGATE_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 284);

    /**
        class com.splicemachine.db.impl.sql.execute.RealScalarAggregateStatistics
    */
    static public final int REAL_SCALAR_AGGREGATE_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 283);

    /**
        class com.splicemachine.db.impl.sql.execute.RealGroupedAggregateStatistics
     */
    static public final int REAL_GROUPED_AGGREGATE_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 285);

    /**
        class com.splicemachine.db.impl.sql.execute.RealSortStatistics
     */
    static public final int REAL_SORT_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 178);

    /**
        class com.splicemachine.db.impl.sql.execute.RealTableScanStatistics
     */
    static public final int REAL_TABLE_SCAN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 179);

    /**
        class com.splicemachine.db.impl.sql.execute.RealHashJoinStatistics
     */
    static public final int REAL_HASH_JOIN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 304);

    /**
        class com.splicemachine.db.impl.sql.execute.RealNestedLoopJoinStatistics
     */
    static public final int REAL_NESTED_LOOP_JOIN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 180);

    /**
        class com.splicemachine.db.impl.sql.execute.RealIndexRowToBaseRowStatistics
     */
    static public final int REAL_INDEX_ROW_TO_BASE_ROW_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 181);

    /**
        class com.splicemachine.db.impl.sql.execute.RealAnyResultSetStatistics
     */
    static public final int REAL_ANY_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 182);

    /**
        class com.splicemachine.db.impl.sql.execute.RealOnceResultSetStatistics
     */
    static public final int REAL_ONCE_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 183);

    /**
        class com.splicemachine.db.impl.sql.execute.RealCurrentOfStatistics
     */
    static public final int REAL_CURRENT_OF_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 184);

    /**
        class com.splicemachine.db.impl.sql.execute.RealRowResultSetStatistics
     */
    static public final int REAL_ROW_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 185);

    /**
        class com.splicemachine.db.impl.sql.execute.RealUnionResultSetStatistics
     */
    static public final int REAL_UNION_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 186);

    /**
        class com.splicemachine.db.impl.sql.execute.RealHashLeftOuterJoinStatistics
     */
    static public final int REAL_HASH_LEFT_OUTER_JOIN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 305);

    /**
        class com.splicemachine.db.impl.sql.execute.RealNestedLoopLeftOuterJoinStatistics
     */
    static public final int REAL_NESTED_LOOP_LEFT_OUTER_JOIN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 187);

    /**
        class com.splicemachine.db.impl.sql.execute.RealNormalizeResultSetStatistics
     */
    static public final int REAL_NORMALIZE_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 188);

    /**
        class com.splicemachine.db.impl.sql.execute.RealInsertResultSetStatistics
     */
    static public final int REAL_INSERT_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 189);

    /**
        class com.splicemachine.db.impl.sql.execute.RealInsertVTIResultSetStatistics
     */
    static public final int REAL_INSERT_VTI_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 379);

    /**
        class com.splicemachine.db.impl.sql.execute.RealUpdateResultSetStatistics
     */
    static public final int REAL_UPDATE_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 190);

    /**
        class com.splicemachine.db.impl.sql.execute.RealDeleteResultSetStatistics
     */
    ...
    /**
       com.splicemachine.db.impl.sql.execute.rts.RealDeleteCascadeResultSetStatistics"
     */
    ...
    /**
        class com.splicemachine.db.impl.sql.execute.RealHashScanStatistics
     */
    static public final int REAL_HASH_SCAN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 203);

    /**
        class com.splicemachine.db.impl.sql.execute.RealDistinctScanStatistics
     */
    static public final int REAL_DISTINCT_SCAN_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 334);

    /**
        class com.splicemachine.db.impl.sql.execute.RealHashTableStatistics
     */
    static public final int REAL_HASH_TABLE_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 306);

    /**
        class com.splicemachine.db.impl.sql.execute.RealVTIStatistics
     */
    static public final int REAL_VTI_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 214);

    /**
        class com.splicemachine.db.impl.sql.execute.RealMaterializedResultSetStatistics
     */
    static public final int REAL_MATERIALIZED_RESULT_SET_STATISTICS_IMPL_V01_ID =
            (MIN_ID_2 + 308);

    /**
        class com.splicemachine.db.impl.sql.execute.RealScrollInsensitiveResultSetStatistics
     */
