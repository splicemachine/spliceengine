/*
   ...
   Derby - Class com.splicemachine.db.iapi.services.monitor.Monitor
...
/**
	...
	<PRE>
	db.service.<EM>service name</EM>=<EM>class name</EM>
	e.g.
	# Added to the properties automatically by the class com.splicemachine.db.jdbc.EmbeddedDriver
	db.service.jdbc=java.sql.Driver
	</PRE>
	<LI>A persistent service can be booted by having a property in the application properties
	or the system (JVM) set.
	<PRE>
	db.service.<EM>service name</EM>=<EM>persistent storage type</EM>
	e.g.
	db.service.mydatabase=serviceDirectory
	</PRE>
  ...
  <P><B>Module Implementations</B><BR>
	...
	<LI>The application properties set (i.e. obtained from the db.properties file).
	<LI>The default implementation properties set (i.e. obtained from the
	/org/apache/db/modules.properties resource).
	</OL>
  ...
  have no effect.
	...
	*/
	...
	public static void startMonitor(Properties bootProperties, PrintStream logging) {
		...
		new com.splicemachine.db.impl.services.monitor.FileMonitor(bootProperties, logging);
	}
	/**
	...
	*/
	...
	public static ModuleFactory getMonitorLite() {
		...
		// for lookup of db.system.home.
		// This instance will be discarded once it is used.				;

		return new com.splicemachine.db.impl.services.monitor.FileMonitor();
	}
