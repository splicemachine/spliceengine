...
public interface Optimizer{
    ...
    int TIME_EXCEEDED=2;
    int NO_TABLES=3;
    int COMPLETE_JOIN_ORDER=4;
    int COST_OF_SORTING=5;
    int NO_BEST_PLAN=6;
    int MODIFYING_ACCESS_PATHS=7;
    int SHORT_CIRCUITING=8;
    int SKIPPING_JOIN_ORDER=9;
    int ILLEGAL_USER_JOIN_ORDER=10;
    int USER_JOIN_ORDER_OPTIMIZED=11;
    int CONSIDERING_JOIN_ORDER=12;
    int TOTAL_COST_NON_SA_PLAN=13;
    int TOTAL_COST_SA_PLAN=14;
    int TOTAL_COST_WITH_SORTING=15;
    int CURRENT_PLAN_IS_SA_PLAN=16;
    int CHEAPEST_PLAN_SO_FAR=17;
    int PLAN_TYPE=18;
    int COST_OF_CHEAPEST_PLAN_SO_FAR=19;
    int SORT_NEEDED_FOR_ORDERING=20;
    int REMEMBERING_BEST_JOIN_ORDER=21;
    int SKIPPING_DUE_TO_EXCESS_MEMORY=22;
    int COST_OF_N_SCANS=23;
    int HJ_SKIP_NOT_MATERIALIZABLE=24;
    int HJ_SKIP_NO_JOIN_COLUMNS=25;
    int HJ_HASH_KEY_COLUMNS=26;
    int CALLING_ON_JOIN_NODE=27;
    int CONSIDERING_JOIN_STRATEGY=28;
    int REMEMBERING_BEST_ACCESS_PATH=29;
    int NO_MORE_CONGLOMERATES=30;
    int CONSIDERING_CONGLOMERATE=31;
    int SCANNING_HEAP_FULL_MATCH_ON_UNIQUE_KEY=32;
    int ADDING_UNORDERED_OPTIMIZABLE=33;
    int CHANGING_ACCESS_PATH_FOR_TABLE=34;
    int TABLE_LOCK_NO_START_STOP=35;
    int NON_COVERING_INDEX_COST=36;
    int ROW_LOCK_ALL_CONSTANT_START_STOP=37;
    int ESTIMATING_COST_OF_CONGLOMERATE=38;
    int LOOKING_FOR_SPECIFIED_INDEX=39;
    int MATCH_SINGLE_ROW_COST=40;
    int COST_INCLUDING_EXTRA_1ST_COL_SELECTIVITY=41;
    int CALLING_NEXT_ACCESS_PATH=42;
    int TABLE_LOCK_OVER_THRESHOLD=43;
    int ROW_LOCK_UNDER_THRESHOLD=44;
    int COST_INCLUDING_EXTRA_START_STOP=45;
    int COST_INCLUDING_EXTRA_QUALIFIER_SELECTIVITY=46;
    int COST_INCLUDING_EXTRA_NONQUALIFIER_SELECTIVITY=47;
    int COST_OF_NONCOVERING_INDEX=48;
    int REMEMBERING_JOIN_STRATEGY=49;
    int REMEMBERING_BEST_ACCESS_PATH_SUBSTRING=50;
    int REMEMBERING_BEST_SORT_AVOIDANCE_ACCESS_PATH_SUBSTRING=51;
    int REMEMBERING_BEST_UNKNOWN_ACCESS_PATH_SUBSTRING=52;
    int COST_OF_CONGLOMERATE_SCAN1=53;
    int COST_OF_CONGLOMERATE_SCAN2=54;
    int COST_OF_CONGLOMERATE_SCAN3=55;
    int COST_OF_CONGLOMERATE_SCAN4=56;
    int COST_OF_CONGLOMERATE_SCAN5=57;
    int COST_OF_CONGLOMERATE_SCAN6=58;
    int COST_OF_CONGLOMERATE_SCAN7=59;
    int COST_INCLUDING_COMPOSITE_SEL_FROM_STATS=60;
    int COMPOSITE_SEL_FROM_STATS=61;
    int COST_INCLUDING_STATS_FOR_INDEX=62;
     ...
     * Optimizer trace.
     */
    void trace(int traceFlag,int intParam1,int intParam2, double doubleParam,Object objectParam1);
