/*
   ...
   Derby - Class com.splicemachine.db.iapi.sql.execute.ResultSetStatisticsFactory
...
public interface ResultSetStatisticsFactory 
{
	 ...
	 */
	String MODULE = "com.splicemachine.db.iapi.sql.execute.ResultSetStatisticsFactory";
