...
/**
 * Utility class for logging Derby messages to log4j.  Finally!  :-)
 * This is mostly a copy of SpliceLogUtils.  It should be consolidated when the two code bases are merged into the same repo.
 * Sadly, all of the JDK 1.5+ stuff has been commented out due to Derby's dependency on JDK 1.4 source.
 *
 * @author dwinters
 *
 */
