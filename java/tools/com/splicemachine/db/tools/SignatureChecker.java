/*
   ...
   Derby - Class com.splicemachine.db.tools.SignatureChecker
...
/**
   ...
   To run from the command-line, enter the following if running on J2SE:
    ...
    <p>
	<code>java com.splicemachine.db.tools.SignatureChecker CONNECTION_URL_TO_DATABASE</code>
	<p>
   ...
   And enter the following if running on J2ME:
    ...
    <p>
	<code>java com.splicemachine.db.tools.SignatureChecker DATABASE_NAME</code>
	<p>
