/*
   ...
   Derby - Class com.splicemachine.db.drda.NetServlet
...
public class NetServlet extends HttpServlet {
	...
	private final static String SERVLET_PROP_MESSAGES =  "com.splicemachine.db.loc.drda.servlet";
	...
	*/
	 ...
	 * Defaults to the settings for db.locale and db.codeset if set
	...
	private LocalizedResource getCurrentAppUI(HttpServletRequest request, String[] locale )
	{
		...
		// if no language specified use one set by db.locale, db.codeset
		locale[ 0 ] = null;
