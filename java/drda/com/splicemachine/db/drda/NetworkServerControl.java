/*
   ...
   Derby - Class com.splicemachine.db.drda.NetworkServerControl
...
package com.splicemachine.db.drda;
...
/** 
	...
	Connections are logged to db.log.
	Default is off.</LI>
	...
	Default is db.system.home, if it is set.
	Otherwise the default is the current directory.</LI>

	</UL>
	</P>
	<P>Properties can be set in the db.properties file or on the command line.
	Properties on the command line take precedence over properties in the 
	db.properties file.  Arguments on the command line take precedence
	over properties. 
	The following is a list of properties that can be set for 
	NetworkServerControl:

	<UL><LI>db.drda.portNumber=&lt;port number>: This property
	indicates which port should be used for the Network Server. </LI>

	<LI>db.drda.host=&lt;host name  or ip address >: This property
	indicates the ip address to which NetworkServerControl should connect. </LI>

	<LI>db.drda.traceDirectory=&lt;trace directory>: This property
	indicates where to put trace files. </LI>

	<LI>db.drda.traceAll=true:  This property turns on tracing for
	all sessions. Default is tracing is off.</LI>

	<LI>db.drda.logConnections=true:  This property turns on logging
	of connections. Default is connections are not logged.</LI>

	<LI>db.drda.minThreads=&lt;value>: If this property
	is set, the &lt;value> number of threads will be created when the Network Server is
	booted. </LI>

	<LI>db.drda.maxThreads=&lt;value>: If this property
	...
	<LI>db.drda.timeSlice=&lt;milliseconds>: If this property
    ...
    <LI>db.drda.sslMode=&lt;sslmode&gt: This property sets the SSL
    mode of the server.
...
<P><B>Examples.</B></P>
	...
	<PRE> 
	java com.splicemachine.db.drda.NetworkServerControl shutdown -p 1621
	</PRE>
	</P>

	<P>This is an example of turning tracing on for session 3
	<PRE>
	java com.splicemachine.db.drda.NetworkServerControl  trace on -s 3
	</PRE>
	</P>
	...
	<PRE>
	java com.splicemachine.db.drda.NetworkServerControl  start -h myhost -p 1621
	java com.splicemachine.db.drda.NetworkServerControl  shutdown -h myhost -p 1621
	</PRE>
	</P>
...
public class NetworkServerControl{
	 ...
	 * and the default port(1527) unless db.drda.portNumber and
	 * db.drda.host are set.
	 * <P><PRE>
	 ...
	 *  is to use the db.drda.startNetworkServer property in
	 *  db.properties.
	 * </P>
	 *  
	 * 
    ...
    /**
     *<p>
     * Find the url of the library directory which holds db.jar and
