/*
   ...
   Derby - Class com.splicemachine.db.mbeans.drda.NetworkServerMBean
 ...
 *
 * @see com.splicemachine.db.drda.NetworkServerControl
...
public interface NetworkServerMBean {
     ...
     * is enabled. Refers to the <code>db.drda.sslMode</code> property.</p>
     * <p>
     ...
     * client. Refers to the <code>db.drda.streamOutBufferSize</code>
     * property.</p>
     * <p>
     ...
     * (sessions). Refers to the <code>db.drda.traceAll</code> server
     * property.</p>
     * <p>
