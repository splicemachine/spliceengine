...
CREATE TABLE "SPLICE"."COLLS" ("ID" VARCHAR(128) NOT NULL, "COLLID" SMALLINT NOT NULL);
CREATE INDEX "SPLICE"."NEW_INDEX3" ON "SPLICE"."COLLS" ("COLLID");
CREATE INDEX "SPLICE"."NEW_INDEX2" ON "SPLICE"."COLLS" ("ID");
ALTER TABLE "SPLICE"."COLLS" ADD CONSTRAINT "NEW_KEY2" UNIQUE ("ID", "COLLID");

CREATE TABLE "SPLICE"."DOCS" ("ID" VARCHAR(128) NOT NULL);
CREATE INDEX "SPLICE"."NEW_INDEX1" ON "SPLICE"."DOCS" ("ID");
ALTER TABLE "SPLICE"."DOCS" ADD CONSTRAINT "NEW_KEY1" PRIMARY KEY ("ID");
...
CREATE TABLE "SPLICE"."COLLS" ("ID" VARCHAR(128), "COLLID" SMALLINT NOT NULL);
CREATE INDEX "SPLICE"."NEW_INDEX3" ON "SPLICE"."COLLS" ("COLLID");
CREATE INDEX "SPLICE"."NEW_INDEX2" ON "SPLICE"."COLLS" ("ID");
insert into colls values ('123', 2);
insert into colls values ('124', -5);
...
drop table docs;
CREATE TABLE "SPLICE"."DOCS" ("ID" VARCHAR(128));
CREATE INDEX "SPLICE"."NEW_INDEX1" ON "SPLICE"."DOCS" ("ID");
