...
Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.GrantRevokeDDLTest
...
public final class GrantRevokeDDLTest extends BaseJDBCTestCase {
    ...
    public void testGrantRevokeDDL() throws Exception
    {
        ...
        st_satConnection.executeUpdate(
            ...
            + "SQL RETURNS NULL ON NULL INPUT EXTERNAL NAME "
            + "'com.splicemachine.dbTesting.functionTests.tests.lang.BooleanValuesTest.booleanValue' LANGUAGE JAVA PARAMETER STYLE JAVA");
        ...
        st_mamta1.executeUpdate(
            ...
            + "NAME "
            + "'com.splicemachine.dbTesting.functionTests.util.ProcedureTest.selectFromSpecificSchema' LANGUAGE JAVA "
    ...
    public void testGrantRevokeDDL2() throws SQLException {
        ...
        st_user1.executeUpdate(
            ...
            + "SQL external name "
            + "'com.splicemachine.dbTesting.functionTests.util.ProcedureTest.grantSelect'");
        ...
        st_user1.executeUpdate(
            ...
            + "style java dynamic result sets 0 language java NO "
            + "SQL external name "
            + "'com.splicemachine.dbTesting.functionTests.util.ProcedureTest.revokeSelect'");
