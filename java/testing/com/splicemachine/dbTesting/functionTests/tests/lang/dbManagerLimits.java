/*
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.lang.dbManagerLimits
...
public class dbManagerLimits
{
    ...
    try {
        ...
        " int) parameter style java language java external name \'com.splicemachine.dbTesting.functionTests.util.ProcedureTest.lessThanMaxParams\' NO SQL";
			s.executeUpdate(tempString);
        ...
        " int, i" + (i+1) + " int) parameter style java language java external name \'com.splicemachine.dbTesting.functionTests.util.ProcedureTest.maxAllowedParams\' NO SQL";
			s.executeUpdate(tempString);
			//just some basic sanity check 
			DatabaseMetaData met = conn.getMetaData();
        ...
        " int, i" + (i+1) + " int, i" + (i+2) + " int) parameter style java language java external name \'com.splicemachine.dbTesting.functionTests.util.ProcedureTest.moreThanMaxAllowedParams\' NO SQL";
			try {
				s.executeUpdate(tempString);
