...
-- beetle 5234
select * from testCS, new com.splicemachine.dbTesting.functionTests.util.VTIClasses.PositiveInteger_VTICosting_SI(col1, 1) a;
select * from new com.acme.myVTI() as T;
select * from new com.splicemachine.dbTesting.not.myVTI() as T;
...
-- VTI in CREATE TRIGGER statement
-- beetle 5234
CREATE TRIGGER testtrig3 AFTER DELETE ON tb1 FOR EACH ROW MODE DB2SQL SELECT * FROM testCS, NEW com.splicemachine.dbTesting.functionTests.util.VTIClasses.PositiveInteger_VTICosting_SI(col1, 1) a;
...
-- beetle 5222
CREATE AGGREGATE STDEV FOR com.splicemachine.dbTesting.functionTests.util.aggregates.StandardDeviation;
DROP AGGREGATE STDEV;
CREATE AGGREGATE MAXBUTONE FOR com.splicemachine.dbTesting.functionTests.util.aggregates.MaxButOneDef;
...
create table mm (x com.splicemachine.dbTesting.functionTests.util.ManyMethods);
create table sc (x com.splicemachine.dbTesting.functionTests.util.SubClass);
...
select x instanceof com.splicemachine.dbTesting.functionTests.util.ManyMethods from mm;
select x instanceof com.splicemachine.dbTesting.functionTests.util.SubClass from mm;
select x instanceof com.splicemachine.dbTesting.functionTests.util.SubSubClass from mm;
...
com.splicemachine.dbTesting.functionTests.util.serializabletypes.City;
...
CREATE CLASS ALIAS FOR com.splicemachine.dbTesting.functionTests.util.serializabletypes.Tour;
