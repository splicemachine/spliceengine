/* 
   ...
   Derby - Class com.splicemachine.dbTesting.functionTests.tests.store.StreamingColumnTest
    ...
    public void testStream10() throws Exception {
        ...
        stmt
                .execute("CREATE FUNCTION ConsistencyChecker() "
                        ...
                        + "'com.splicemachine.dbTesting.functionTests.util.T_ConsistencyChecker.runConsistencyChecker' "
