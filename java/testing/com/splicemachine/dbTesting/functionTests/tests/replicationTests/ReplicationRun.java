...
Derby - Class com.splicemachine.dbTesting.functionTests.tests.replicationTests.ReplicationRun
 ...
 */
package com.splicemachine.dbTesting.functionTests.tests.replicationTests;
...
public class ReplicationRun extends BaseTestCase
{
    ...
    throws IOException
    {
        ...
        /* Done in subclasses
        replicationTest = "com.splicemachine.dbTesting.functionTests.tests.replicationTests.ReplicationTestRun";
        util.DEBUG("replicationTest: " + replicationTest);
        replicationVerify = "com.splicemachine.dbTesting.functionTests.tests.replicationTests.ReplicationTestRunVerify";
...
# Test to run:
test.preStartedMasterServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartMasterCmdTooEarly
...
test.preStartedMasterServer.return=true
        ...
        {
            runStateTest(testPreStartedMasterServer, // E.g. com.splicemachine.dbTesting.functionTests.tests.replicationTests.TestPreStartedMasterServer
                    jvmVersion,
...
test.preStartedSlaveServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartSlaveCmdTooEarly
test.preStartedSlaveServer.return=true
         */
        util.DEBUG("****** BEGIN testPreStartedSlaveServer");
        if ( testPreStartedSlaveServer != null )
        {
            runStateTest(testPreStartedSlaveServer, // E.g. com.splicemachine.dbTesting.functionTests.tests.replicationTests.TestPreStartedSlaveServer
                    jvmVersion,
...
test.preStartedMaster.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartMasterCmd_OK
# test.preStartedMaster.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartMasterCmd_ERR
test.preStartedMaster.return=true
         */
        util.DEBUG("****** BEGIN testPreStartedMaster");
        if ( testPreStartedMaster != null )
        {
            runStateTest(testPreStartedMaster, // E.g. com.splicemachine.dbTesting.functionTests.tests.replicationTests.TestPreStartedMaster
                    jvmVersion,
                    testClientHost, // using connect. On masterServerHost using CLI
                    masterServerHost, masterServerPort,
                    replicatedDb);
...
test.preInitSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartSlaveCmd_OK
# test.preInitSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartSlaveCmd_ERR
...
test.preStartedSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartSlaveCmd_OK
# test.preStartedMaster.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StartSlaveCmd_ERR
...
test.postStartedMasterAndSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.XXXX_OK
# test.postStartedMasterAndSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.XXXX_ERR
...
test.preStoppedMaster.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StopMasterCmd_OK
# test.preStoppedMaster.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StopMasterCmd_ERR
...
test.preStoppedMasterServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.YYYYY_OK
# test.preStoppedMasterServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.YYYYY_ERR
...
test.preStoppedSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StopSlaveCmd_OK
# test.preStoppedSlave.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.StopSlaveCmd_ERR
...
test.preStoppedSlaveServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.ZZZZZZ_OK
# test.preStoppedSlaveServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.ZZZZZZ_ERR
...
test.postStoppedSlaveServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.ZZZXXX_OK
# test.postStoppedSlaveServer.test=com.splicemachine.dbTesting.functionTests.tests.replicationTests.ZZZXXX_ERR
        ...
        Load(String id, Properties testRunProperties)
        {
            ...
            else
            {
                ...
                load = testRunProperties.getProperty(pid,
                        "com.splicemachine.dbTesting.functionTests.tests.replicationTests.DefaultLoad");
                util.DEBUG(pid+": " + load);
