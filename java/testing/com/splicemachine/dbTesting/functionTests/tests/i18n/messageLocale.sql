...
driver 'com.splicemachine.dbTesting.functionTests.tests.i18n.DefaultLocale';
...
create procedure checkDefaultLoc() parameter style java language java external name 'com.splicemachine.dbTesting.functionTests.tests.i18n.DefaultLocale.checkDefaultLocale';
drop procedure checkDatabaseLoc;
create procedure checkDatabaseLoc(in locale char(10)) parameter style java language java external name 'com.splicemachine.dbTesting.functionTests.tests.i18n.DefaultLocale.checkDatabaseLocale';
drop procedure setDefaultDELoc;
create procedure setDefaultLoc(in locale char(10), in code char(10)) parameter style java language java external name 'com.splicemachine.dbTesting.functionTests.tests.i18n.DefaultLocale.setDefaultLocale';
drop table t1;
drop table t2;
