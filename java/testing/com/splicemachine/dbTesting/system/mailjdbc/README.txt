...
3. Run java com.splicemachine.dbTesting.system.mailjdbc.MailJdbc embedded
 or
 java com.splicemachine.dbTesting.system.mailjdbc.MailJdbc NetworkServer (To run in the NetworkServer mode you should start the n/w server manually)
4. If you want to use the same database as the previous run, 
   Run java com.splicemachine.dbTesting.system.mailjdbc.MailJdbc embedded samedb
 or
  java com.splicemachine.dbTesting.system.mailjdbc.MailJdbc NetworkServer samedb (To run in the NetworkServer mode you should start the n/w server manually)
