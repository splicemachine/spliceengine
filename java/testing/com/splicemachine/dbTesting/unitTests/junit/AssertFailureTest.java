/*
   Derby - Class com.splicemachine.dbTesting.unitTests.junit.AssertFailureTest
...
public class AssertFailureTest extends BaseTestCase {
    ...
    private static String POLICY_FILENAME =
            "com/splicemachine/dbTesting/unitTests/junit/AssertFailureTest.policy";

    /**
     * Security policy file that DOESN'T allow thread dumps.
     */
    private static String NO_DUMP_POLICY_FILENAME =
            "com/splicemachine/dbTesting/unitTests/junit/AssertFailureTest1.policy";
