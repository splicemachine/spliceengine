/*
   ...
   Derby - Class com.splicemachine.dbTesting.unitTests.store.T_RecoverFullLog
...
/**
	...
	derby.module.test.recoverFullLog=com.splicemachine.dbTesting.unitTests.store.T_RecoverFullLog

    Execute in order

	java -DTestFillLog=true com.splicemachine.dbTesting.unitTests.harness.UnitTestMain

	java -DTestLogSwitchFail=true com.splicemachine.dbTesting.unitTests.harness.UnitTestMain

	java -DTestFullRecoveryFail=true com.splicemachine.dbTesting.unitTests.harness.UnitTestMain
		(run this serveral times, this simulate recovery running out of log)

	java -DTestFullRecover=true com.splicemachine.dbTesting.unitTests.harness.UnitTestMain
