 ...
 * see http://db.apache.org/db/papers/versionupgrade.html
 * </p>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>db.release.id.new</b> - The new id for the branch, in case we were asked to bump the release id.</li>
 * </ul>
 */
...
public class ReleaseProperties extends Task
{
   ...
   /**
     ...
     * property db.release.id.new equal to the resulting release id.
     * </p>
     */
    public  void    execute()
