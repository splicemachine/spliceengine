/*
   ...
   Derby - Class com.splicemachine.derbyBuild.eclipse.DerbyEclipsePlugin
...
package com.splicemachine.derbyBuild.eclipse;
...
import com.splicemachine.db.iapi.services.info.PropertyNames;
 ...
 *   be: com.splicemachine.db.core_<major>.<minor>.<interim> (example: com.splicemachine.db.core_10.1.0).
 *
 ...
 *
 * - The current packaging includes db.jar, derbynet.jar and
...
public class DerbyEclipsePlugin{
	 ...
	 */
	private static String PLUGIN_PKG="plugin.db.core";
	private static String PLUGIN_PKG_NAME="com.splicemachine.db.core";
	/*
	 * Derby plug-in zip file property and name
	 */
	private static String PLUGIN_ZIP_FILE="plugin.db.core.zipfile";
	private static String PLUGIN_ZIP_FILE_NAME="derby_core_plugin";
	/*
	 * Derby plug-in build properties and name
	 */
	private static String PLUGIN_VERSION="plugin.db.version";
	private static String PLUGIN_VERSION_BUILD_NUMBER="plugin.db.version.build.number";
