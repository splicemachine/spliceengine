/*  Derby - Class com.splicemachine.derbyBuild.ReleaseNotesTransformer
...
public class ReleaseNotesTransformer extends Task
{
    ...
    private static final String PREAMBLE =
        ...
        "    </ul>\n" +
        "    <p> <a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-bin.zip\">db-db-{0}-bin.zip</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-bin.zip.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-bin.zip.md5\">MD   5</a>]<br/>\n" +
        "    <a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-bin.tar.gz\">db-db-{0}-bin.tar.gz</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-bin.tar.gz.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-bin.tar.gz.md5\">MD5</a>]</p>\n" +
        "    \n" +
        "    <p><a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-lib.zip\">db-db-{0}-lib.zip</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib.zip.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib.zip.md5\">MD5<  /a>]<br/>\n" +
        "    <a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-lib.tar.gz\">db-db-{0}-lib.tar.gz</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib.tar.gz.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib.tar.gz.md5\"> MD5</a>]</p>\n" +
        "    \n" +
        "    <p><a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-lib-debug.zip\">db-db-{0}-lib-debug.zip</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib-debug.zip.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib-debug.zip.md5\">MD5</a>]<br/>\n" +
        "    <a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-lib-debug.tar.gz\">db-db-{0}-lib-debug.tar.gz</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib-debug.tar.gz.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-lib-debug.tar.gz.md5\">MD5</a>]</p>\n" +
        "\n" +
        "    <p><a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-src.zip\">db-db-{0}-src.zip</a>  [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-src.zip.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-src.zip.md5\">MD5  </a>]<br/>\n" +
        "    <a href=\"[preferred]/db/db/db-db-{0}/db-db-{0}-src.tar.gz\">db-db-{0}-src.tar.gz</a> [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-src.tar.gz.asc\">PGP</a>] [<a href=\"http://www.apache.org/dist/db/db/db-db-{0}/db-db-{0}-src.tar.gz.md5\">MD5</a>] (Note that, due to long filenames, you will need gnu tar to unravel this tarball.)</p>\n";
