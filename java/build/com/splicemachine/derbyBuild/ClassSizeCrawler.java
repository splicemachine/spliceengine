/*
   ...
   Derby - Class com.splicemachine.db.iapi.services.cache.ClassSizeCrawler
 ...
 *<p>
 * java -DWS=<i>work-space</i> [-DclassDir=<i>class-dir</i>] [-Dout=<i>out-file</i> [-Dprefix[.<i>x</i>=<i>package-prefix</i>]] [-Dverbose=true] com.splicemachine.db.iapi.services.cache.ClassSizeCrawler <i>class-or-interface</i> ...<br>
 *<p>
 ...
 * <code>
 * java -DWS=$WS \
 *      -Dprefix.1=com.splicemachine.db.iapi.types \
...
public class ClassSizeCrawler
{
    public static void main( String[] arg)
    {
        ...
        String outputFileName =
          System.getProperty( "out", WS + "/java/com.splicemachine.db.iapi.services.cache.ClassSizeCatalog.java");
        try
        {
