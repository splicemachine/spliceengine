/*
   ...
   Derby - Class com.splicemachine.db.client.net.NetLogWriter
...
public class NetLogWriter extends com.splicemachine.db.client.am.LogWriter {
    ...
    synchronized public void traceProtocolFlow(byte[] buff,
        ...
        if (!loggingEnabled(com.splicemachine.db.jdbc.ClientDataSource.TRACE_PROTOCOL_FLOWS)) {
            return;
        }
        synchronized (printWriter_) {
