/*
   ...
   Derby - Class com.splicemachine.db.client.net.NetAgent
...
import com.splicemachine.db.client.am.Utils;
...
public class NetAgent extends Agent {
    ...
    public NetAgent(NetConnection netConnection,
                    com.splicemachine.db.client.am.LogWriter logWriter) throws SqlException {
    ...
    protected void resetAgent_(com.splicemachine.db.client.am.LogWriter netLogWriter,
    ...
    public void throwCommunicationsFailure(Throwable cause) 
        ...
        //com.splicemachine.db.client.am.DisconnectException
        ...
        accumulateChainBreakingReadExceptionAndThrow(
            new com.splicemachine.db.client.am.DisconnectException(this,
                new ClientMessageId(SQLState.COMMUNICATION_ERROR),
    ...
    public com.splicemachine.db.client.am.LogWriter newLogWriter_(java.io.PrintWriter printWriter,
                                                              int traceLevel) {
    ...
    public void beginWriteChain(com.splicemachine.db.client.am.Statement statement) throws SqlException {
        request_.initialize();
        writeDeferredResetConnection();
    ...
    protected void beginReadChain(com.splicemachine.db.client.am.Statement statement) throws SqlException {
