/*
   ...
   Derby - Class com.splicemachine.db.client.am.LogWriter
...
public class LogWriter {
    ...
    final protected boolean traceSuspended() {
        return com.splicemachine.db.client.am.Configuration.traceSuspended__;
    }
    ...
    private void dncprintln(String header, String s) {
        synchronized (printWriter_) {
            printWriter_.println("[db]" + header + " " + s);
            printWriter_.flush();
        }
    }
    ...
    private void dncprint(String header, String s) {
        synchronized (printWriter_) {
            printWriter_.print("[db]" + header + " " + s);
            printWriter_.flush();
        }
    }
    ...
    private String getClassNameOfInstanceIfTraced(Object instance) {
        ...
        // we don't use instanceof javax.transaction.XAResource to avoid dependency on j2ee.jar
                ...
                instance.getClass().getName().startsWith("com.splicemachine.db.client.net.NetXAResource")) {
            return "NetXAResource";
        } else if (loggingEnabled(ClientDataSource.TRACE_ALL) &&
                instance.getClass().getName().equals("com.splicemachine.db.client.ClientPooledConnection")) {
            return "ClientPooledConnection";
        } else if (loggingEnabled(ClientDataSource.TRACE_ALL) &&
                instance.getClass().getName().equals("com.splicemachine.db.jdbc.ClientConnectionPoolDataSource")) {
            return "ClientConnectionPoolDataSource";
        } else if (loggingEnabled(ClientDataSource.TRACE_ALL) &&
                instance.getClass().getName().equals("com.splicemachine.db.client.ClientXAConnection")) {
            return "ClientXAConnection";
        } else if (loggingEnabled(ClientDataSource.TRACE_ALL) &&
                instance.getClass().getName().equals("com.splicemachine.db.jdbc.ClientDataSource")) {
            return "ClientDataSource";
        } else if (loggingEnabled(ClientDataSource.TRACE_ALL) &&
                instance.getClass().getName().equals("com.splicemachine.db.jdbc.ClientXADataSource")) {
    ...
    public void traceDiagnosable(SqlException e) {
        ...
        synchronized (printWriter_) {
            ...
            ExceptionFormatter.printTrace(e, printWriter_, "[db]", true); // true means return tokens only
    ...
    public void traceDiagnosable(javax.transaction.xa.XAException e) {
        ...
        synchronized (printWriter_) {
            dncprintln("BEGIN TRACE_DIAGNOSTICS");
            ExceptionFormatter.printTrace(e, printWriter_, "[db]");
            dncprintln("END TRACE_DIAGNOSTICS");
        }
    }
    // ------------------------ meta data tracing --------------------------------
    ...
    public void writeDriverConfiguration() {
        com.splicemachine.db.client.am.Version.writeDriverConfiguration(printWriter_);
    }
