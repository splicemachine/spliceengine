/*
   ...
   Derby - Class com.splicemachine.db.client.ClientPooledConnection
...
public class ClientPooledConnection implements javax.sql.PooledConnection {
    ...
    //@GuardedBy("this")
    com.splicemachine.db.client.am.LogicalConnection logicalConnection_ = null;

    protected com.splicemachine.db.client.am.LogWriter logWriter_ = null;
