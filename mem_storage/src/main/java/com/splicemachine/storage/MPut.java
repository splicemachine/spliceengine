...
public class MPut implements DataPut{
    ...
    public void tombstone(long txnIdLong){
        DataCell tCell = new MCell(
                key,SIConstants.DEFAULT_FAMILY_BYTES, SIConstants.SNAPSHOT_ISOLATION_TOMBSTONE_COLUMN_BYTES,
    ...
    public void antiTombstone(long txnIdLong){
        DataCell tCell = new MCell(
                key, SIConstants.DEFAULT_FAMILY_BYTES, SIConstants.SNAPSHOT_ISOLATION_TOMBSTONE_COLUMN_BYTES,
                txnIdLong, SIConstants.SNAPSHOT_ISOLATION_ANTI_TOMBSTONE_VALUE_BYTES, CellType.ANTI_TOMBSTONE);
        data.add(tCell);
    ...
    public void addFirstWriteToken(byte[] family, long txnIdLong) {
        DataCell tCell = new MCell(
                key, family, SIConstants.SNAPSHOT_ISOLATION_FIRST_WRITE_TOKEN_COLUMN_BYTES,
    ...
    public void addCell(byte[] family,byte[] qualifier,long timestamp,byte[] value){
        ...
        else if (qualifier == SIConstants.SNAPSHOT_ISOLATION_FIRST_WRITE_TOKEN_COLUMN_BYTES)
