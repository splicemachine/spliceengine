/*
   ...
   Derby - Class com.splicemachine.db.jdbc.ClientBaseDataSource
...
import com.splicemachine.db.client.ClientDataSourceFactory;
...
public abstract class ClientBaseDataSource implements Serializable, Referenceable {
    ...
    static
    {
        ...
        try
        {
            ...
            // is loaded.
            new com.splicemachine.db.client.am.EncryptionManager(null);
     ...
     * one if it is possible. Currently db server only has support for USRIDPWD,
    ...
    public static short getUpgradedSecurityMechanism(String password) {
        ...
        if (SUPPORTS_EUSRIDPWD)
            ...
            // a db server < 10.2, and hence does not support
    ...
    /**
     * Check if db.client.traceDirectory is provided as a JVM property.
    ...
    public Reference getReference() throws NamingException {
        ...
        // name of the object factory, com.splicemachine.db.client.ClientBaseDataSourceFactory,
...
// display in the error message.
    ...
    /**
     * Check if db.client.traceLevel is provided as a JVM property.
