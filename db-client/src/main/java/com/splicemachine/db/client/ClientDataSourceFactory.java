/*
   ...
   Derby - Class com.splicemachine.db.client.ClientDataSourceFactory
 ...
 *
 * @see com.splicemachine.db.jdbc.ClientDataSource
 * @see com.splicemachine.db.jdbc.ClientConnectionPoolDataSource
 * @see com.splicemachine.db.jdbc.ClientXADataSource
 */
public class ClientDataSourceFactory implements javax.naming.spi.ObjectFactory {
    ...
    public Object getObjectInstance(Object refObj,
        ...
        if (refObj instanceof javax.naming.Reference) {
            ...
            if (className != null &&
                    className.startsWith("com.splicemachine.db.jdbc.Client")) {
