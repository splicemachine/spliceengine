...
public class Clob extends Lob implements java.sql.Clob{
    ...
    java.io.InputStream asciiStream_=null;
    java.io.InputStream unicodeStream_=null;
    java.io.Reader characterStream_=null;
    ...
    public Clob(Agent agent,
        ...
        switch(encoding){
            ...
            case "UTF-8":  // "UTF-8"
                ...
                break;
            case "UnicodeBigUnmarked":  // "UnicodeBigUnmarked"
                try{
                    characterStream_= new java.io.InputStreamReader(inputStream,"UnicodeBigUnmarked");
                }catch(java.io.UnsupportedEncodingException e){
                    throw new SqlException(agent_.logWriter_,
                            new ClientMessageId(SQLState.UNSUPPORTED_ENCODING),
     ...
     *                    allowed.
     */
    public Clob(Agent agent,java.io.InputStream inputStream,String encoding) throws SqlException{
    ...
    java.io.InputStream getAsciiStreamX() throws SqlException{
        ...
        if(isAsciiStream()){  // this Lob is used for input
            ...
            //Clob.
            return new UpdateSensitiveClobLocatorInputStream(agent_.connection_,this);
        }else{
        ...
        try{
            synchronized(agent_.connection_){
                ...
                if(isLocator()){ // Check to see if the Lob is locator enabled
                    ...
                    outStream=new ClobLocatorOutputStream(this,pos);
                }else{
                    //The Lob is not locator enabled.
                    outStream=new ClobOutputStream(this,pos);
                }
                if(agent_.loggingEnabled()){
    ...
    public Reader getCharacterStream(long pos,long length)
        ...
        synchronized(agent_.connection_){
            ...
            if(isLocator()){
                ...
                //   Clob object.
                try{
                    retVal=new UpdateSensitiveClobLocatorReader(agent_.connection_,this, pos,length);
    ...
    protected void materializeStream()
            throws SqlException{
        unicodeStream_=super.materializeStream(isAsciiStream()? asciiStream_: unicodeStream_, "java.sql.Clob");
        dataType_=UNICODE_STREAM;
    }
    ...
    long getLocatorLength() throws SqlException{
        return agent_.connection_.locatorProcedureCall().clobGetLength(locator_);
    }
}
