...
public class ClusteredConnection implements Connection{
    ...
    public ClusteredConnection(ClusteredDataSource dataSource){
        this.connectionManager = new ClusterConnectionManager(dataSource);
    }

    @Override
    public Statement createStatement() throws SQLException{
        checkClosed();
        ClusteredStatement cs = new ClusteredStatement(connectionManager);
    ...
    public boolean getAutoCommit() throws SQLException{
        return connectionManager.autoCommit;
    }
