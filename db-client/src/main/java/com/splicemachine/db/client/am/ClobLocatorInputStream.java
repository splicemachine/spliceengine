...
class ClobLocatorInputStream extends java.io.InputStream{
     ...
     */
    ClobLocatorInputStream(Connection connection,Clob clob) throws SqlException{
     ...
     */
    ClobLocatorInputStream(Connection connection,Clob clob,long pos) throws SqlException{
