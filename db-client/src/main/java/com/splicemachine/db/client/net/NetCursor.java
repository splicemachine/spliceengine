...
import com.splicemachine.db.client.am.Lob;
...
public class NetCursor extends com.splicemachine.db.client.am.Cursor {
    ...
    private int readFdocaInt() throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private int readFdocaOneByte() throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    // Reads 1-byte from the dataBuffer from the current position.
    // If position is already at the end of the buffer, send CNTQRY to get more data.
    private int readFdocaOneByte(int index) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private byte[] readFdocaBytes(int length) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private int readFdocaTwoByteLength() throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private int readFdocaTwoByteLength(int index) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private int skipFdocaBytes(int length) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
        checkForSplitRowAndComplete(length);
        position_ += length;
        return length;
    }

    private int skipFdocaBytes(int length, int index) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private void shiftPartialRowToBeginning() {
        ...
        System.arraycopy(dataBuffer_, currentRowPosition_ + 0, dataBuffer_, 0, length);
    ...
    NetSqlca[] parseSQLCARD(Typdef typdef) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private NetSqlca[] parseSQLCAGRP(Typdef typdef) throws com.splicemachine.db.client.am.DisconnectException, SqlException {
    ...
    private String readFdocaString(int length, String encoding) throws DisconnectException, SqlException {
        ...
        try {
            ...
            netAgent_.accumulateChainBreakingReadExceptionAndThrow(
                new com.splicemachine.db.client.am.DisconnectException(
                    netAgent_, 
    ...
    /**
     * @see com.splicemachine.db.client.am.Cursor#getBlobColumn_
     */
    ...
    /**
     * @see com.splicemachine.db.client.am.Cursor#getClobColumn_
     */
    ...
    /**
     * @see com.splicemachine.db.client.am.Cursor#getRowIdColumn_
     */
    ...
    private void checkAndThrowReceivedEndqryrm() throws SqlException {
        ...
        if (!netResultSet_.openOnServer_) {
            ...
            int sqlcode = com.splicemachine.db.client.am.Utils.getSqlcodeFromSqlca(netResultSet_.queryTerminatingSqlca_);
            if (sqlcode < 0) {
