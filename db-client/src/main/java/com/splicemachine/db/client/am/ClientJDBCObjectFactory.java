...
public interface ClientJDBCObjectFactory{
    ...
    CallableStatement newCallableStatement(Agent agent,
                                           com.splicemachine.db.client.am.Connection connection,String sql,
     ...
     */
    com.splicemachine.db.client.am.Connection newNetConnection(
            LogWriter netLogWriter,
            int driverManagerLoginTimeout,String serverName,
            int portNumber,String databaseName,java.util.Properties properties) throws SqlException;
    ...
    ResultSet newNetResultSet(Agent netAgent,MaterialStatement netStatement,
                              ...
                              int actualResultSetConcurrency,int actualResultSetHoldability) throws SqlException;
    ...
    Statement newStatement(Agent agent,
                           com.splicemachine.db.client.am.Connection connection) throws SqlException;
