...
class ClusteredCallableStatement extends ClusteredPreparedStatement implements CallableStatement{
    ...
    ClusteredCallableStatement(RefCountedConnection referenceConn,ClusteredConnection sourceConnection,CallableStatement statement){
        super(referenceConn,sourceConnection,statement);
