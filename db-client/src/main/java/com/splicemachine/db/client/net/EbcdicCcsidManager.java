/*
   ...
   Derby - Class com.splicemachine.db.client.net.EbcdicCcsidManager
...
public class EbcdicCcsidManager extends CcsidManager {
    ...
    public byte[] convertFromJavaString(String sourceString, com.splicemachine.db.client.am.Agent agent) throws SqlException {
