...
public class Statement implements java.sql.Statement, StatementCallbackInterface{
     ...
     * @throws SQLException if a database access error occurs (according to
    ...
    void writeSetSpecialRegister(java.util.ArrayList sqlsttList)
        ...
        materialStatement_.writeSetSpecialRegister_(setSpecialRegisterSection_,sqlsttList);
    }
    ...
    public void completeOpenQuery(Sqlca sqlca,ResultSet resultSet){
        ...
        if(resultSet_.fetchSize_==0 &&
            ...
            resultSet_.setFetchSize_(com.splicemachine.db.client.am.
    ...
    public void completeExecuteCallOpenQuery(Sqlca sqlca,ResultSet resultSet,ColumnMetaData resultSetMetaData,Section generatedSection){
        ...
        if(resultSet.fetchSize_==0){
            resultSet.fetchSize_=com.splicemachine.db.client.am.Configuration.defaultFetchSize;
        }
    }
     ...
     * listeners list in <code>com.splicemachine.db.client.am.Connection</code>.
     * <p>
     ...
     * <p>
     * 2. <code>com.splicemachine.db.client.am.Connection#markStatementsClosed</code>
     ...
     * @throws SqlException if the number of result sets does not
    ...
    protected void setupCursorNameCacheAndMappings(){
        if(cursorName_!=null){
            ...
            connection_.clientCursorNameCache_.put(cursorName_, cursorName_);
        }else{
            // canned cursor name
            agent_.sectionManager_.mapCursorNameToQuerySection
    ...
    String substituteClientCursorNameWithServerCursorName(String sql, Section section) throws SqlException{
    ...
    String escape(String sql) throws SqlException{
        return connection_.nativeSQLX(sql);
    }
    ...
    String cacheCursorAttributesToSendOnPrepare() throws SqlException{
        ...
        return
                cursorAttributes.toString().equals("")
                        ?null
                        :cursorAttributes.toString();
    }


    private void getPreparedStatementForAutoGeneratedKeys() throws SqlException{
        if(preparedStatementForAutoGeneratedKeys_==null){
            ...
            StringBuilder cursorAttributes=new StringBuilder().append(Configuration.cursorAttribute_WithHold);
    ...
    void removeClientCursorNameFromCache(){
        if(cursorName_!=null &&
     ...
     */
    void resultSetCommitting(ResultSet closingRS) throws SqlException{
     ...
     * @throws SqlException
     */
    boolean resultSetCommitting(ResultSet closingRS,boolean writeChain) throws SqlException{
    ...
    SQLException jdbc3FeatureNotSupported(boolean checkStatement)
            throws SQLException{
        try{
            if(checkStatement)
                checkForClosedStatement();
    ...
    void closeMeOnCompletion(){
        ...
        if(active && (!closingResultSets_) && closeOnCompletion_){
            try{
                if(isOpen(resultSet_)){
                    return;
                }
                if(isOpen(generatedKeysResultSet_)){
                    return;
                }
