...
public class CachingLogicalConnection extends LogicalConnection{
    ...
    public synchronized PreparedStatement prepareStatement(
            ...
            throws SQLException{
        checkForNullPhysicalConnection();
        return cacheInteractor.prepareStatement(sql,resultSetType,resultSetConcurrency);
    }
    ...
    public synchronized PreparedStatement prepareStatement(
            ...
            throws SQLException{
        checkForNullPhysicalConnection();
        return cacheInteractor.prepareStatement(sql,resultSetType,resultSetConcurrency,resultSetHoldability);
    }
