...
# bash docker_run.sh --- /bin/bash docker/exec_and_sqlshell.sh <additional ./start-splice-cluster parameters>
...
# bash docker_run.sh -p 1527:1527 -p 4000:4000 -p 4020:4020 -p 4025:4025 --- /bin/bash docker/exec_and_sqlshell.sh -l

# shortcut for these mapping is --stdPortMap
# docker_run.sh --stdPortMap --- /bin/bash docker/exec_and_sqlshell.sh -l
...
# ./docker_start-splice-cluster.sh -b
# 
