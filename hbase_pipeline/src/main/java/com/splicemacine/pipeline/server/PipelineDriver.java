...
import com.splicemacine.derby.hbase.CoprocessorWriterFactory;
import com.splicemacine.derby.hbase.YammerPipelineMeter;
...
public class PipelineDriver{
    ...
    public static void loadDriver(PipelineEnvironment env){
        ...
        INSTANCE = new PipelineDriver(config,ctxFactoryDriver,pef,partitionFactory,compressor);
    }
    ...
    private PipelineDriver(SConfiguration config,
        ...
        CoprocessorWriterFactory writerFactory=new CoprocessorWriterFactory(pipelineWriter,writePipelineFactory,compressor,pef);
        try{
