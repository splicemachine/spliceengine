    ...
    */
    ...
    public static TestSetup connectionCPDecorator(Test test)
    {
        return new ConnectorSetup(test,
             "com.splicemachine.dbTesting.junit.ConnectionPoolDataSourceConnector");
    }
    ...
    {
        return new ConnectorSetup(test,
                "com.splicemachine.dbTesting.junit.XADataSourceConnector");
    }
    /**
     * Return a decorator that changes the configuration to obtain
    ...
    {
        return new ConnectorSetup(test,
            "com.splicemachine.dbTesting.junit.DataSourceConnector");
    }
    ...
    private void initConnector(Connector oldConnector)
    {
        ...
        else if (JDBC.vmSupportsJDBC3())
        {
            try {
                connector = (Connector) Class.forName(
                  "com.splicemachine.dbTesting.junit.DriverManagerConnector").newInstance();
            } catch (Exception e) {
                Assert.fail(e.getMessage());
            }
