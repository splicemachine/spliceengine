/*
   ...
   Derby - Class com.splicemachine.db.diag.LockTable
...
// temp
import com.splicemachine.db.impl.services.locks.TableNameInfo;
...
public class LockTable extends VTITemplate implements VTICosting  {
	...
	*/
	...
	/**
		...
		LockTable(com.splicemachine.db.diag.LockTable->TABLE_AND_ROWLOCK).
	...
	*/
        ...
        throws StandardException
    {
		...
		if (lockCount != 0)
			state = "GRANT";
		else if (!(lock instanceof com.splicemachine.db.impl.services.locks.ActiveLock))
			return null;
		else
			state = "WAIT";
