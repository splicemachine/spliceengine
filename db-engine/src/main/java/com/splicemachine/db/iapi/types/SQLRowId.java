...
public class SQLRowId extends DataType implements RowLocation, RowId{
    ...
    public SQLRowId(TypeMessage.SQLRowId sqlRowId) {
        init(sqlRowId);
    }
    ...
    public TypeMessage.DataValueDescriptor toProtobuf() throws IOException {
        TypeMessage.SQLRowId.Builder builder = TypeMessage.SQLRowId.newBuilder();
        ...
        TypeMessage.DataValueDescriptor dvd = TypeMessage.DataValueDescriptor.newBuilder()
                .setType(TypeMessage.DataValueDescriptor.Type.SQLRowId)
                .setExtension(TypeMessage.SQLRowId.sqlRowId, builder.build())
                .build();
        return dvd;
    }
    @Override
    ...
    protected void readExternalNew(ObjectInput in)  throws IOException  {
        ...
        TypeMessage.SQLRowId sqlRowId =
                dataValueDescriptor.getExtension(TypeMessage.SQLRowId.sqlRowId);
        init(sqlRowId);
    }

    private void init(TypeMessage.SQLRowId sqlRowId){
