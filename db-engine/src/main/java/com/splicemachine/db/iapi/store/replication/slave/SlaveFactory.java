/*
   ...
   Derby - Class
   com.splicemachine.db.iapi.store.replication.slave.SlaveFactory
...
package com.splicemachine.db.iapi.store.replication.slave;
...
public interface SlaveFactory {
     ...
     * @exception StandardException Thrown if slave is connected with
     * master
     * @see com.splicemachine.db.iapi.store.replication.master.MasterFactory
     * @see com.splicemachine.db.impl.store.replication.master.MasterController#flushedTo
     */
