                                     ...
                                     implements NumberDataValue
{
     ...
     */
    static DataValueDescriptor ZERO_DECIMAL = new SQLDecimal("0");
    ...
    */
    public void setBigDecimal(Number bigDecimal) throws StandardException
    {
        ...
        if (   (bdc.compareTo(NumberDataType.MINLONG_MINUS_ONE) > 0)
            && (bdc.compareTo(NumberDataType.MAXLONG_PLUS_ONE) < 0)) {
    ...
    */
    ...
    public StringDataValue digits(NumberDataValue source, int len, StringDataValue result) throws StandardException {
        ...
        if (decimalPoint != -1) {
            sb.append(sourceString, 0, decimalPoint);
            sb.append(sourceString, decimalPoint+1, sourceLen+1);
        } else
