...
public interface LanguageConnectionContext extends Context {
    ...
    */
    ...
    ManagedCache<UUID, SPSDescriptor> getSpsCache();

    ManagedCache<Long, Conglomerate> getConglomerateCache();

    Conglomerate localConglomerateCacheFind(Long conglomId);

    void localConglomerateCacheAdd(Long conglomId, Conglomerate conglomerate);
