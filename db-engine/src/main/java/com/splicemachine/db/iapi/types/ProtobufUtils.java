...
public class ProtobufUtils {
    ...
    private static final ExtensionRegistry extensionRegistry = createDVDExtensionRegistry();

    private static ExtensionRegistry createAggregatorExtensionRegistry() {
    ...
    private static ExtensionRegistry createDVDExtensionRegistry() {
        ExtensionRegistry extensionRegistry = ExtensionRegistry.newInstance();
        // DVD extensions
        ...
        // BaseTypeIdImpl extensions
        extensionRegistry.add(CatalogMessage.DecimalTypeIdImpl.decimalTypeIdImpl);
        extensionRegistry.add(CatalogMessage.RowMultiSetImpl.rowMultiSetImpl);
        extensionRegistry.add(CatalogMessage.UserDefinedTypeIdImpl.userDefinedTypeImpl);

        // AggregateAliasInfo extensions
        extensionRegistry.add(CatalogMessage.UserDefinedTypeIdImpl.userDefinedTypeImpl);
        extensionRegistry.add(CatalogMessage.DecimalTypeIdImpl.decimalTypeIdImpl);
        extensionRegistry.add(CatalogMessage.RowMultiSetImpl.rowMultiSetImpl);

        // TypeDescriptorImpl extensions
        extensionRegistry.add(CatalogMessage.UserDefinedTypeIdImpl.userDefinedTypeImpl);
        extensionRegistry.add(CatalogMessage.DecimalTypeIdImpl.decimalTypeIdImpl);
        extensionRegistry.add(CatalogMessage.RowMultiSetImpl.rowMultiSetImpl);
        return extensionRegistry;
