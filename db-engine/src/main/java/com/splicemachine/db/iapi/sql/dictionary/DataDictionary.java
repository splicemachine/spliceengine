/*
   ...
   Derby - Class com.splicemachine.db.iapi.sql.dictionary.DataDictionary
...
public interface DataDictionary{
    ...
    */
    ...
    int SYSTABLEPERMS_CATALOG_NUM=14;
    int SYSCOLPERMS_CATALOG_NUM=15;
    int SYSROUTINEPERMS_CATALOG_NUM=16;
    int SYSROLES_CATALOG_NUM=17;
