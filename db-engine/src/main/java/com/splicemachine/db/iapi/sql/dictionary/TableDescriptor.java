...
//        assert tableType==TableDescriptor.VIEW_TYPE:"tableType expected to be TableDescriptor.VIEW_TYPE";
    ...
    public ValueRow getDefaultValue(int columnNumber) {
        DataValueDescriptor dvd = getColumnDescriptor(columnNumber).getDefaultValue();
        return new ValueRow(new DataValueDescriptor[]{dvd});
    }
