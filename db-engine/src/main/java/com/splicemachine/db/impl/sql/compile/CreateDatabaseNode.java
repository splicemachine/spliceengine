...
/**
 * A CreateDatabaseNode is the root of a QueryTree that
...
public class CreateDatabaseNode extends DDLStatementNode
{
     ...
     *
     * @param dbName    The name of the new db
     *
        ...
        throws StandardException
    {
        ...
        */
        ...
        this.name = ((String) dbName).toUpperCase();
    }
     ...
     * object to require CREATE_DATABASE_PRIV at execution time.
     */
    ...
    {
        return getGenericConstantActionFactory().getCreateDatabaseConstantAction(name);
    }
}
