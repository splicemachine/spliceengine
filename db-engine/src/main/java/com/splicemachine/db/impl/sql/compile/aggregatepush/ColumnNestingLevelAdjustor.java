...
/**
 * Created by yxia on 4/6/17.
 */
public class ColumnNestingLevelAdjustor extends AbstractSpliceVisitor implements Visitor {
    int sourceTableNumber;

    public ColumnNestingLevelAdjustor(int sTableNumber) {
        sourceTableNumber = sTableNumber;
    }
    ...
    public Visitable visit(Visitable node, QueryTreeNode parent) throws StandardException {
        ...
        int nestingLevel = ((ColumnReference)node).getNestingLevel();
