/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.heap.HeapRowLocation
...
public class HeapRowLocation extends DataType implements RowLocation
{
	...
	**/
    ...
    = ClassSize.estimateBaseFromCatalog( com.splicemachine.db.impl.store.raw.data.RecordId.class);
