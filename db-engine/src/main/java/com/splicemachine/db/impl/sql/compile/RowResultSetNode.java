...
public class RowResultSetNode extends FromTable {
    ...
    public ResultSetNode optimize(DataDictionary dataDictionary,
        ...
        */
        ...
        subqueries.optimize(dataDictionary, outerRows);
        return this;
    }
    ...
    void optimizeSubqueries(DataDictionary dd, double rowCount) throws StandardException {
        subqueries.optimize(dd, rowCount);
    }
    ...
    */
    ...
    protected boolean determineSpark() throws StandardException {
        if (subqueries.determineSpark()) {
            setDataSetProcessorType(subqueries.getDataSetProcessorType());
            return true;
        }
        return false;
    }
