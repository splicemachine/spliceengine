...
public class DeleteNode extends DMLModStatementNode
{
    ...
    public static final String NO_CHECKS = "noChecks";
    ...
    static public Properties getDeleteProperties(Properties tableProperties)
    {
        ...
        String noChecks = (String)tableProperties.remove(NO_CHECKS);

        Properties deleteProperties = null;
        if (dir != null || noChecks != null) {
            deleteProperties = new FormatableProperties();
            if( dir != null )
                deleteProperties.setProperty(BULK_DELETE_DIRECTORY, dir);
            if( noChecks != null ) {
                deleteProperties.setProperty(NO_CHECKS, noChecks);
            }
        }
                            ...
                            throws StandardException
    {
        ...
        if ("getDeleteResultSet".equals(resultSetGetter)) {
            ...
            BaseJoinStrategy.pushNullableString(mb, isNoChecksMode() ? "1" : "0" );
    ...
    private boolean isNoChecksMode() {
        String s =  targetProperties != null ? targetProperties.getProperty(NO_CHECKS) : null;
        ...
        throws StandardException
    {
        ...
        FormatableBitSet columnMap = DeleteNode.getDeleteReadMap(baseTable,conglomVector, relevantTriggers,
                needsDeferredProcessing, bulkDeleteDirectory!=null, isNoChecksMode());
        ...
        throws StandardException
    {
        ...
        */
         ...
         */
        baseTable.getAllRelevantTriggers( isNoChecksMode ? StatementType.LOAD_REPLACE : StatementType.DELETE, (int[])null, relevantTriggers );
