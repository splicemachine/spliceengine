...
import com.splicemachine.db.iapi.types.RowLocation;
    ...
    *
    */
   class WindowResultSet extends GenericAggregateResultSet implements CursorResultSet {
       ...
       * @exception StandardException Thrown on error
       ...
       public WindowResultSet(NoPutResultSet source, boolean isInSortedOrder, int aggregateItem,
           ...
           {
               SanityManager.DEBUG("WindowTrace", "execution time: " +
                   activation.getPreparedStatement().getSavedObject(aggregateItem));
           }
     ...
     {
         if (SanityManager.DEBUG)
             SanityManager.ASSERT(isOpen, "WindowResultSet expected to be open");
