...
public class HalfOuterJoinNode extends JoinNode{
    ...
    public HalfOuterJoinNode(ResultSetNode leftResult, ResultSetNode rightResult, Object onClause, Object usingClause,
                             Boolean rightOuterJoin, ResultColumnList selectList, Properties tableProperties,
                             ContextManager contextManager) throws StandardException {
        setContextManager(contextManager);
        setNodeType(C_NodeTypes.HALF_OUTER_JOIN_NODE);
        init(leftResult, rightResult, onClause, usingClause, rightOuterJoin, selectList, tableProperties);
    }
