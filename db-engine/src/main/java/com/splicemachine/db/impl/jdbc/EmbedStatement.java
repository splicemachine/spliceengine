...
public class EmbedStatement extends ConnectionChild implements EngineStatement {
    private static final Logger LOG = Logger.getLogger(EmbedStatement.class);
...
//
//                long MINIMUM_EXECUTION_TIME_TRACE_MS = 10;
//                if(endTime - beginTime > MINIMUM_EXECUTION_TIME_TRACE_MS)
//                    LOG.info("ELAPSED TIME FOR " + sql + " is " + Long.toString(endTime - beginTime) + " ms.");
     ...
     *
     * @throws SQLException Feature not implemented for now.
     */
    @Override
     ...
     *
     * @throws SQLException Exception if it cannot find the connection
            ...
            try {
                ...
                */
                ...
                if (resultsToWrap.returnsRows()) {
                    ...
                    long[] updateCounts = resultsToWrap.modifiedRowCount();
     ...
     *
     * @throws SQLException Thrown if the statement is marked as closed.
     * @see #checkExecStatus()
     */
