/*
   ...
   Derby - Class com.splicemachine.db.impl.store.access.btree.BTreeScan
...
public abstract class BTreeScan extends OpenBTree implements ScanManager
{
    ...
    **/
    ...
    @see com.splicemachine.db.iapi.store.access.GenericScanController#newRowLocationTemplate
