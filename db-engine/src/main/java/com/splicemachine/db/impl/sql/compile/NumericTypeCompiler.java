...
public final class NumericTypeCompiler extends BaseTypeCompiler
{
    ...
    public int getCastToCharWidth(DataTypeDescriptor dts, CompilerContext compilerContext)
    {
        ...
        switch (formatId)
        {
            ...
            case StoredFormatIds.DECFLOAT_TYPE_ID:
                // Need to have space for '-' and decimal point.
                return TypeCompiler.DECFLOAT_DECIMAL_PRECISION + 2;
    ...
    */
    String dataValueMethodName()
    {
        ...
        else if (getStoredFormatIdFromTypeId() == StoredFormatIds.DECFLOAT_TYPE_ID)
            return "getDecfloatDataValue";
        else
