...
public class FromVTI extends FromTable implements VTIEnvironment {
    ...
    */
    ...
    public FromVTI(MethodCallNode invocation, String correlationName, ResultColumnList derivedRCL, Properties tableProperties,
                   TableName exposedName, ContextManager contextManager) {
        super();
    }
