...
public class IsNode extends BinaryLogicalOperatorNode {
    ...
    public ValueNode bindExpression(FromList fromList,
        ...
        getLeftOperand().checkIsBoolean();
        getRightOperand().checkIsBoolean();

        setType(getLeftOperand().getTypeServices());
                    ...
                    throws StandardException
    {
        ...
        setLeftOperand(getLeftOperand().eliminateNots(false));
        setRightOperand(getRightOperand().eliminateNots(false));
    ...
    public ValueNode putAndsOnTop()
                    throws StandardException
    {
        setLeftOperand(getLeftOperand().putAndsOnTop());
    ...
    {
        return ( getLeftOperand().verifyPutAndsOnTop() && getRightOperand().verifyPutAndsOnTop() );
    }
    ...
    {
        return    ( getLeftOperand().verifyChangeToCNF() && getRightOperand().verifyChangeToCNF() );
    }
