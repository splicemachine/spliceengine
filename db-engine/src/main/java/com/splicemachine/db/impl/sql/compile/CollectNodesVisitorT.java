 ...
 *
 */
public class CollectNodesVisitorT<T extends Visitable> implements Visitor
{
    private List<T> nodeList;
    private Class<T> nodeClass;
    private Class<? extends Visitable> skipOverClass;
     ...
     */
    public CollectNodesVisitorT(Class<T> nodeClass) {
     ...
     */
    public CollectNodesVisitorT(Class<T> nodeClass, Class<? extends Visitable> skipOverClass) {
        this(nodeClass);
