...
{
	public static LongOpenHashSet systemConglomerates = new LongOpenHashSet();;
		...
		throws StandardException
	{
		...
		DataDictionaryImpl.populateSystemConglomerates(getDataDictionary().getCoreInfo());
		DataDictionaryImpl.populateSystemConglomerates(getDataDictionary().getNoncoreInfo());
    }
