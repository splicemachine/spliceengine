...
public class CreateViewNode extends DDLStatementNode
{
	...
	public TableDescriptor createDynamicView() throws StandardException {
		...
		TableDescriptor td = ddg.newTableDescriptor(getRelativeName(),sd,TableDescriptor.WITH_TYPE,TableDescriptor.ROW_LOCK_GRANULARITY,-1,null,null,null,null,null, null,false,false,0);
