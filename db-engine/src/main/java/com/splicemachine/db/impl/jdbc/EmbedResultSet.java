	...
	*/
		...
		throws SQLException
	{
		...
		synchronized (getConnectionSynchronization()) {
			...
			//if (onRow && !(currentRow instanceof com.splicemachine.db.impl.sql.execute.ValueRow))
...
//				rvalue = ((ScrollInsensitiveResultSet)theResults).isDeleted();
	...
	public void insertRow() throws SQLException {
        synchronized (getConnectionSynchronization()) {
            ...
            try {
                ...
                com.splicemachine.db.iapi.sql.PreparedStatement ps =
                ...
                //execute the insert
                com.splicemachine.db.iapi.sql.ResultSet rs =
    ...
    public void deleteRow() throws SQLException {
        synchronized (getConnectionSynchronization()) {
            ...
            try {
                ...
                com.splicemachine.db.iapi.sql.PreparedStatement ps = lcc.prepareInternalStatement(deleteWhereCurrentOfSQL.toString());
	...
	*/
    ...
    /* 
     * @see com.splicemachine.db.iapi.jdbc.EngineResultSet#isNull(int)
     */
