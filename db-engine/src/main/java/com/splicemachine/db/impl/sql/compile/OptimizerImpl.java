    ...
    private void costBasedCostOptimizable(Optimizable optimizable,
        ...
        if (memoryOK) {
            ...
            if (isCurrentAccessPathBetter(currentAccessPath, bestAccessPath, optimizable, predList)) {
                ...
                bestAccessPath.setUisPredicate(currentAccessPath.getUisPredicate());
                bestAccessPath.setUisRowIdPredicate(currentAccessPath.getUisRowIdPredicate());
                bestAccessPath.setUnionOfIndexes(currentAccessPath.getUnionOfIndexes());
                bestAccessPath.setUisRowIdJoinBackToBaseTableResultSet(currentAccessPath.getUisRowIdJoinBackToBaseTableResultSet());
                ...
                if(requiredRowOrdering.sortRequired(currentRowOrdering, assignedTableMap, optimizableList)
                    ...
                    if (memoryOK) {
                        ...
                        if (isCurrentAccessPathBetter(currentAccessPath, bestSortAvoidancePath, optimizable, predList)) {
                            ...
                            bestSortAvoidancePath.setCoveringIndexScan(
                            ...
                            bestSortAvoidancePath.setUisPredicate(currentAccessPath.getUisPredicate());
                            bestSortAvoidancePath.setUisRowIdPredicate(currentAccessPath.getUisRowIdPredicate());
                            bestSortAvoidancePath.setUnionOfIndexes(currentAccessPath.getUnionOfIndexes());
                            bestSortAvoidancePath.setUisRowIdJoinBackToBaseTableResultSet(currentAccessPath.getUisRowIdJoinBackToBaseTableResultSet());
