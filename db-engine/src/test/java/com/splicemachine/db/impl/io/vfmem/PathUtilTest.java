...
public class PathUtilTest {
    ...
    public void testGetParent() {
        ...
        assertEquals("seg0", PathUtil.getParent(join("seg0", "c1.dat")));
        assertEquals(abs("seg0"), PathUtil.getParent(joinAbs("seg0", "c1.dat")));
        assertNull(PathUtil.getParent("seg0" + SEP));
        assertEquals(SEP, PathUtil.getParent(abs("seg0" + SEP)));
        assertEquals(joinAbs("dir1", "dir2"), PathUtil.getParent(joinAbs("dir1", "dir2", "myFile.txt")));
    }

    @Test
    public void testGetBase() {
        assertEquals("seg0", PathUtil.getBaseName("seg0"));
        assertEquals("c1.dat", PathUtil.getBaseName(join("seg0", "c1.dat")));
        assertEquals("c1.dat", PathUtil.getBaseName(joinAbs("seg0", "c1.dat")));
        assertEquals("c1.dat", PathUtil.getBaseName(join("aDir", "seg0", "c1.dat")));
        assertEquals("c1.dat", PathUtil.getBaseName(joinAbs("aDir", "seg0", "c1.dat")));
    }
