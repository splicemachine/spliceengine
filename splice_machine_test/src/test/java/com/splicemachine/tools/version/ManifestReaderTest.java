...
public class ManifestReaderTest {
    ...
    public void createVersion_release() throws Exception {
        ManifestFinder manifestFinder = mockManifest("1.0.0");
        ManifestReader manifestReader = new ManifestReader(manifestFinder);
        SpliceMachineVersion version = manifestReader.createVersion();
    ...
    public void testNullManifest() throws Exception {
        SpliceMachineVersion version = new ManifestReader().createVersion();
        System.out.println(version);
        assertEquals("Unknown", version.getBuildTime());
        assertEquals("Unknown", version.getImplementationVersion());
        assertEquals("Unknown", version.getRelease());
        assertEquals("Unknown", version.getURL());
    }
