...
@CommandLine.Command(name = "slist", description = "list SpliceMachine schemas (similar to sysschemas)" )
public class SListCommand extends CommonOptions implements Callable<Integer>
{
    @Override
    public Integer call() throws Exception {
        HBaseInspector hbaseInspector = new HBaseInspector(Utils.constructConfig(zkq, port));
        System.out.println(hbaseInspector.listSchemas());
        return 0;
    }
}
