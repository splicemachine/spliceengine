...
public enum DataBlockEncoding {
    ...
    SPLICEMACHINE(7, "com.splicemachine.io.hbase.encoding.PAXDataBlockEncoder");
    ...
    private static Map<Short, org.apache.hadoop.hbase.io.encoding.DataBlockEncoding> idToEncoding =
            new HashMap<Short, org.apache.hadoop.hbase.io.encoding.DataBlockEncoding>();

    static {
        for (org.apache.hadoop.hbase.io.encoding.DataBlockEncoding algo : values()) {
    ...
    public static boolean isCorrectEncoder(DataBlockEncoder encoder,
        ...
        org.apache.hadoop.hbase.io.encoding.DataBlockEncoding algorithm = idToEncoding.get(encoderId);
        String encoderCls = encoder.getClass().getName();
        return encoderCls.equals(algorithm.encoderCls);
    }

    public static org.apache.hadoop.hbase.io.encoding.DataBlockEncoding getEncodingById(short dataBlockEncodingId) {
