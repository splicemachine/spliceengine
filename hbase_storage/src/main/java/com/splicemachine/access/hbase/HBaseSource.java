...
import com.splicemachine.access.api.SSource;
import java.io.IOException;

/**
 * Created by jleach on 11/18/15.
 */
public class HBaseSource implements SSource {
    ...
    @Override
    public SConnectionFactory getSpliceConnectionFactory() throws IOException {
