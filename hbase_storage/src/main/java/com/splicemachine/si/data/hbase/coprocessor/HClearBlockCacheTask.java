...
public class HClearBlockCacheTask implements ClearBlockCacheTask {
    ServerName serverName;
    public HClearBlockCacheTask(ServerName serverName){
    ...
    public void run() {
        try {
            ...
            SpliceMessage.Empty request = SpliceMessage.Empty.getDefaultInstance();
            service.clearBlockCache(null, request);
        } catch (Exception e) {
