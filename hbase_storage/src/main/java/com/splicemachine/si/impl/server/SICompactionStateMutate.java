...
class SICompactionStateMutate {
    ...
    private SICompactionStateMutate(PurgeConfig purgeConfig, long lowWatermarkTransaction) {
    ...
    static public long mutate(PurgeConfig purgeConfig, long lowWatermarkTransaction,
                              List<Cell> rawList, List<TxnView> txns, List<Cell> results) throws IOException {
        SICompactionStateMutate impl = new SICompactionStateMutate(purgeConfig, lowWatermarkTransaction);
