 ...
 */
private[splicemachine] case class JDBCPartitioningInfo(
    column: String,
    lowerBound: Long,
    upperBound: Long,
    numPartitions: Int)

private[splicemachine] object JDBCRelation extends Logging {
  /**
...
private[splicemachine] case class JDBCRelation(
