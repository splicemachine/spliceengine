...
import org.apache.spark.sql.execution.datasources.jdbc.{JdbcUtils, SpliceRelation, JdbcOptionsInWrite, JDBCRDD}
...
class DefaultSource extends RelationProvider with CreatableRelationProvider
  ...
  BaseRelation = {
    new SpliceRelation(new JdbcOptionsInWrite(parameters))(sqlContext,None)
  }
  ...
  BaseRelation = {
    ...
    try {
      ...
      if (tableExists) {
        val actualRelation = new SpliceRelation(new JdbcOptionsInWrite(parameters))(sqlContext,Option.apply(df.schema))
  ...
  override def createRelation(sqlContext: SQLContext, parameters: Map[String, String],
                              schema: StructType):
  BaseRelation = {
    new SpliceRelation(new JdbcOptionsInWrite(parameters))(sqlContext,Option.apply(schema))
  }
