...
SPLICE_HBASE_REGIONSERVER_OPTS="$SPLICE_HBASE_REGIONSERVER_OPTS -XX:MaxPermSize=256M"
...
SPLICE_HBASE_REGIONSERVER_OPTS="$SPLICE_HBASE_REGIONSERVER_OPTS -Xms24576m"
SPLICE_HBASE_REGIONSERVER_OPTS="$SPLICE_HBASE_REGIONSERVER_OPTS -Xmx24576m"
...
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -XX:NewRatio=16"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -XX:CMSInitiatingOccupancyFraction=70"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -XX:+UseCMSInitiatingOccupancyOnly"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -XX:MaxGCPauseMillis=100"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Xms1024m"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Xmx1024m"
