...
#    items.extend(resultItems)
  ...
  def getHBaseSiteDesiredValues(self):
    hbase_site_desired_values = {
        ...
        "hbase.coprocessor.regionserver.classes" : "org.apache.ranger.authorization.hbase.RangerAuthorizationCoprocessor,com.splicemachine.hbase.RegionServerLifecycleObserver,com.splicemachine.si.data.hbase.coprocessor.RegionServerEndpoint",
  ...
  def getMasterDashDProperties(self):
    dashDProperties = [
        ...
        "splice.spark.yarn.am.extraJavaOptions=-Dhdp.version=2.6.5.0-292",
        "splice.spark.driver.extraJavaOptions=-Dhdp.version=2.6.5.0-292",
        ...
        "splice.spark.executor.extraJavaOptions=-Dhdp.version=2.6.5.0-292",
        "splice.spark.executor.extraLibraryPath=/usr/hdp/current/hadoop-client/lib/native",
        "splice.spark.executor.extraClassPath=/usr/hdp/current/hbase-regionserver/conf:/usr/hdp/current/hbase-regionserver/lib/htrace-core-3.1.0-incubating.jar:/var/lib/splicemachine/*:/usr/hdp/2.6.5.0-292/spark2/jars/*:/usr/hdp/current/hbase-master/lib/*",
        "splice.spark.yarn.jars=/usr/hdp/2.6.5.0-292/spark2/jars/*"
      ]
