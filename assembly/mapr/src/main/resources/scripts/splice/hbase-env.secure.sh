...
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -verbose:class"
...
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Dsplice.spark.yarn.am.extraJavaOptions=-verbose:class"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Dsplice.spark.yarn.executor.memoryOverhead=2048"
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Dsplice.spark.driver.extraJavaOptions=-verbose:class -Dlog4j.configuration=file:/etc/spark/conf/log4j.properties"
...
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Dsplice.spark.executor.extraJavaOptions=-verbose:class -Dlog4j.configuration=file:/etc/spark/conf/log4j.properties"
...
SPLICE_HBASE_REGIONSERVER_OPTS="$SPLICE_HBASE_REGIONSERVER_OPTS -verbose:class"
