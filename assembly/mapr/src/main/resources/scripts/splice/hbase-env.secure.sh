...
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Dsplice.spark.driver.extraClassPath=/opt/mapr/hbase/##HBASEVERSION##-splice/conf:/opt/mapr/hbase/##HBASEVERSION##-splice/lib/*:/opt/splice/default/lib/*"
...
SPLICE_HBASE_MASTER_OPTS="$SPLICE_HBASE_MASTER_OPTS -Dsplice.spark.executor.extraClassPath=/opt/mapr/hbase/##HBASEVERSION##-splice/conf:/opt/mapr/hbase/##HBASEVERSION##-splice/lib/*:/opt/splice/default/lib/*"
