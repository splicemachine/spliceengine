...
public class MetaDataAccessControlIT {
    ...
    private static SpliceSchemaWatcher  spliceSchemaWatcherA = new SpliceSchemaWatcher(null, SCHEMA_A);
    private static SpliceSchemaWatcher  spliceSchemaWatcherB = new SpliceSchemaWatcher(null, SCHEMA_B);
    private static SpliceSchemaWatcher  spliceSchemaWatcherC = new SpliceSchemaWatcher(null, SCHEMA_C);
    private static SpliceSchemaWatcher  spliceSchemaWatcherF = new SpliceSchemaWatcher(null, SCHEMA_F);
    private static SpliceSchemaWatcher  spliceSchemaWatcherZ = new SpliceSchemaWatcher(null, SCHEMA_Z);
    private static SpliceSchemaWatcher  spliceSchemaWatcherY = new SpliceSchemaWatcher(null, SCHEMA_Y);
