...
public class CsvLineReaderCRTest {
    void test(String s, String[] expected, boolean skipCarriageReturn, int configBufferSize) throws IOException {
        List<String> res = new ArrayList<String>();
        CsvLineReaderCR r = new CsvLineReaderCR(new StringReader(s), skipCarriageReturn, 1024, configBufferSize);
    ...
    public void test1() throws IOException {
        test( "Hello\nWorld\n", new String[]{"Hello", "World"}, true, 1024);
        test( "Hello\nWorld\n", new String[]{"Hello", "World"}, false, 1024);
    }
    @Test
    public void test2() throws IOException {
        test( "Hello\r\nWorld\r\n", new String[]{"Hello", "World"}, true, 1024);
        test( "Hello\r\nWorld\r\n", new String[]{"Hello\r", "World\r"}, false, 1024);
    }

    @Test
    public void test3() throws IOException {
        boolean crNewline = true;
        test("", new String[]{}, true, 5);

        // CASE 1 : skipCarriageReturn=true/false, configBufferSize=10
        // 1234\n
        test("1234\n", new String[]{"1234"}, true, 10);
        // CASE 2 : skipCarriageReturn=true/false, configBufferSize=10
        // 1234<EOF>
        test("1234", new String[]{"1234"}, true, 10);

        // CASE 3 : skipCarriageReturn=true, configBufferSize=20
        // 123\r\n123\r\n
        test("123\r\n123\r\nabc\n", new String[]{"123", "123", "abc"}, true, 20);
        test("123\r\n123\r\nabc\n", new String[]{"123\r", "123\r", "abc"}, false, 20);
        ...
        if (crNewline) {
            test("123\r123\r\nabc\n", new String[]{"123", "123", "abc"}, true, 20);
            test("123\r123\r\nabc\n", new String[]{"123\r123\r", "abc"}, false, 20);
        } else {
            test("123\r123\r\nabc\n", new String[]{"123\r123", "abc"}, true, 20);
            test("123\r123\r\nabc\n", new String[]{"123\r123\r", "abc"}, false, 20);
        }

        // CASE 5 : skipCarriageReturn=true, configBufferSize=5
        // 1234\r<EOF>
        test("1234\r", new String[]{"1234"}, true, 5);
        ...
        // 1234\r\n
        // abc\r\n
        test("1234\r\nabc\r\n", new String[]{"1234", "abc"}, true, 5);
        test("1234\r\nabc\r\n", new String[]{"1234\r", "abc\r"}, false, 5);

        // CASE 7 : skipCarriageReturn=true, configBufferSize=5
        // 1234\rA
    }
    @Test    public void test4() throws IOException {
        test( "1234\rA", new String[]{"1234", "A"}, true, 5);
