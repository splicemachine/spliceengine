...
public class ExportParamsTest {
    ...
    public void constructor() throws StandardException {
        ...
        ExportParams exportParams = new ExportParams("/dir", null, "csv", 42, "ascii", "F", "Q", "always");
    ...
    public void constructor_testDefaults() throws StandardException {
        ...
        ExportParams exportParams = new ExportParams("/dir", "BZ2", "csv", -1, null, null, null, null);
        ...
        assertEquals(ExportParams.QuoteMode.DEFAULT, exportParams.getQuoteMode());
    }

    @Test
    public void constructor_whileSpaceDelimitersAreAllowed() throws StandardException {
        ExportParams exportParams = new ExportParams("/dir", "noNe", "csv", -1, null, " ", " ", null);
        assertEquals(' ', exportParams.getFieldDelimiter());
        assertEquals(' ', exportParams.getQuoteChar());
        assertEquals(ExportFile.COMPRESSION.NONE, exportParams.getCompression());
    }
    ...
    public void constructor_usingJavaEscapeSequencesToDesignateArbitraryUnicodeCharactersForDelimiters() throws StandardException {
        ...
        ExportParams params2 = new ExportParams("/dir", "gZIP ", "csv", -1, null, "\\u0300", "\\u0400", null);
    ...
    public void constructor_badExportDirectory() {
        try {
            new ExportParams(null, "GZIP", "csv", 1, "UTF-8", ",", null, null);
            fail();
        } catch (Exception e) {
    ...
    public void constructor_badCharacterEncoding() {
        try {
            new ExportParams("/dir", "BZ2", "csv", 1, "NON_EXISTING_CHARSET", ",", null, null);
            fail();
    ...
    public void constructor_badFieldDelimiter() {
        try {
            new ExportParams("/dir", "GZIP", "csv", 1, "UTF-8", ",,,", null, null);
            fail();
        } catch (Exception e) {
    ...
    public void constructor_badQuoteCharacter() {
        try {
            new ExportParams("/dir", "GZ", "csv", 1, "UTF-8", ",", "||||", null);
            fail();
        } catch (Exception e) {
    ...
    public void constructor_bad_QuoteMode() {
        try {
            new ExportParams("/dir", "GZ", "csv", 1, "UTF-8", ",", "|", "FOO");
            fail();
        } catch (Exception e) {
