...
public class SortOperationIT extends SpliceUnitTest { 
	...
	protected static SpliceTableWatcher spliceTableWatcher4 = new SpliceTableWatcher(TABLE_NAME_4,CLASS_NAME,"(id int, txt char(20))");
	...
	public static TestRule chain = RuleChain.outerRule(spliceClassWatcher)
		...
		.around(new SpliceDataWatcher(){
			...
			protected void starting(Description description) {
				...
				spliceClassWatcher.executeUpdate(format("insert into %s.%s(txt) values ('4')",CLASS_NAME,TABLE_NAME_4));
				spliceClassWatcher.executeUpdate(format("insert into %s.%s(txt) values ('45')",CLASS_NAME,TABLE_NAME_4));
...
//        }
	...
	public void testNullsFirstPartial() throws Exception {
		ResultSet rs = methodWatcher.executeQuery(format("select txt, id from %s.%s order by id nulls first,txt",CLASS_NAME,TABLE_NAME_4));
		String test = "TXT | ID  |\n" +
				"------------\n" +
				"  4  |NULL |\n" +
				" 45  |NULL |\n" +
