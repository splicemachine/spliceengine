...
public class StatisticsAdminIT{
    ...
    public static void createSharedTables() throws Exception{
        ...
        new TableCreator(conn4)
                /* tinyint is not supported on 2.5, use smallint instead of tinyint on 2.5 for column a5*/
                .withCreate("create table t5 (a5 smallint, b5 smallint, c5 int, d5 bigint, e5 real, f5 double, g5 decimal(10,2), " +
