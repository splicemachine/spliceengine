...
//    private static final BitFormat bitFormat = new BitFormat(false);
    ...
    public void bucket() throws Exception {
        assertEquals("11000000", Integer.toBinaryString(SpreadBucket.FOUR.bucket(Integer.MAX_VALUE)));
        assertEquals("11100000", Integer.toBinaryString(SpreadBucket.EIGHT.bucket(Integer.MAX_VALUE)));
        assertEquals("11110000", Integer.toBinaryString(SpreadBucket.SIXTEEN.bucket(Integer.MAX_VALUE)));
        assertEquals("11111000", Integer.toBinaryString(SpreadBucket.THIRTY_TWO.bucket(Integer.MAX_VALUE)));
        assertEquals("11111100", Integer.toBinaryString(SpreadBucket.SIXTY_FOUR.bucket(Integer.MAX_VALUE)));
        assertEquals("11111110", Integer.toBinaryString(SpreadBucket.ONE_TWENTY_EIGHT.bucket(Integer.MAX_VALUE)));
        assertEquals("11111111", Integer.toBinaryString(SpreadBucket.TWO_FIFTY_SIX.bucket(Integer.MAX_VALUE)));
    }
