...
public class ProtoUtil {
    ...
    public static Index createIndex(long conglomerate, IndexDescriptor indexDescriptor, List<DataValueDescriptor> defaultValues) {
        byte [] defaultValuesBytes = null;
        if (defaultValues!=null && !defaultValues.isEmpty()) {
            ValueRow defaultValueRow = new ValueRow(defaultValues.toArray(new DataValueDescriptor[defaultValues.size()]));
            defaultValuesBytes = SerializationUtils.serialize(defaultValueRow);
        }
    ...
    public static DDLChange createTentativeIndexChange(long txnId, LanguageConnectionContext lcc, long baseConglomerate, long indexConglomerate,
                                                       TableDescriptor td, IndexDescriptor indexDescriptor, List<DataValueDescriptor> defaultValues) throws StandardException {
