...
public class GrantRevokeConstantOperation extends DDLConstantOperation {
    ...
    public void executeConstantAction( Activation activation ) throws StandardException {
        ...
        for (PermissionsDescriptor permissionsDescriptor : permissionsDescriptors) {
            createAndNotifyDDLChange(((SpliceTransactionManager) tc), permissionsDescriptor, grant);
        }
    }

    private void createAndNotifyDDLChange(SpliceTransactionManager tc, PermissionsDescriptor permissionsDescriptor, boolean grant) throws StandardException {
