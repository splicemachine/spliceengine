 ...
 */
public class UpgradeScriptForDroppedConglomerates extends UpgradeScriptBase {
    private static final Logger LOG = Logger.getLogger(UpgradeScriptForDroppedConglomerates.class);
    public UpgradeScriptForDroppedConglomerates(SpliceDataDictionary sdd, TransactionController tc) {
        super(sdd, tc);
    }
