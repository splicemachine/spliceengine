...
public class SpliceDatabase extends BasicDatabase{
    ...
    @Override
    public LanguageConnectionContext setupConnection(ContextManager cm,String user, String groupuser, String password,
                                                     String drdaID,String dbname,
        ...
        final LanguageConnectionContext lctx=super.setupConnection(cm, user, groupuser, password, drdaID, dbname, dspt,
                skipStats, defaultSelectivityFactor, ipAddress);
     ...
     */
    public LanguageConnectionContext generateLanguageConnectionContext(TxnView txn,ContextManager cm,String user,
                                                                       String groupuser, String password, String drdaID,
                                                                       String dbname, CompilerContext.DataSetProcessorType type,
                                                                       boolean skipStats,
                                                                       double defaultSelectivityFactor,
        ...
        pushDbContext(cm);
        LanguageConnectionContext lctx=lcf.newLanguageConnectionContext(cm,tc,lf,this,user,groupuser,password,drdaID,dbname,type,skipStats, defaultSelectivityFactor, ipAddress);
