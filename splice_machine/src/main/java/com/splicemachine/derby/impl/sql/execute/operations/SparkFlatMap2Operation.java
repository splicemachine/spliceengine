 ...
 */
public abstract class SparkFlatMap2Operation<Op extends SpliceBaseOperation, From, From2, To>
	...
	public SparkFlatMap2Operation() {
	}

	protected SparkFlatMap2Operation(Op spliceOperation, SpliceObserverInstructions soi) {
		this.soi = soi;
