...
/**
 * Created by yxia on 11/2/20.
 */
public class UpgradeScriptToAddBaseTableSchemaColumnsToSysTablesInSYSIBM extends UpgradeScriptBase {
    public UpgradeScriptToAddBaseTableSchemaColumnsToSysTablesInSYSIBM(SpliceDataDictionary sdd, TransactionController tc) {
        super(sdd, tc);
    }
