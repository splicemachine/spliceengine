...
public class SpliceCatalogUpgradeScripts{
    ...
    static final public Splice_DD_Version baseVersion3 = new Splice_DD_Version(null, 3, 0, 1);
    static final public Splice_DD_Version baseVersion4 = new Splice_DD_Version(null, 3, 0, 1);
