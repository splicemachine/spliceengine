...
public class SpliceCatalogUpgradeScripts{
    ...
    public SpliceCatalogUpgradeScripts(SpliceDataDictionary sdd,Splice_DD_Version catalogVersion,TransactionController tc){
        ...
        scripts.put(new Splice_DD_Version(sdd,2,5,0, 1842), new UpgradeScriptForDroppedConglomerates(sdd,tc));
        scripts.put(new Splice_DD_Version(sdd,2,5,0, 1849), new UpgradeScriptToRemoveFKDependencyOnPrivileges(sdd,tc));
        scripts.put(new Splice_DD_Version(sdd,2,5,0, 1851), new UpgradeScriptToAddUseExtrapolationInSysColumns(sdd,tc));
