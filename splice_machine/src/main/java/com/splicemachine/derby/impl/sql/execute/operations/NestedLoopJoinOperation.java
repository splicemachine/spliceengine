...
public class NestedLoopJoinOperation extends JoinOperation {
    ...
    private static final Logger LOG = Logger.getLogger(NestedLoopJoinOperation.class);
    private static final List<NodeType> NODE_TYPES = ImmutableList.of(NodeType.MAP, NodeType.SCROLL);
    private static final String NAME = NestedLoopJoinOperation.class.getSimpleName().replaceAll("Operation", "");
