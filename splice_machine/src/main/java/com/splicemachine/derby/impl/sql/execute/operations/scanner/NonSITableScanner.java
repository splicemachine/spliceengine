 ...
 * Date: 4/4/14
 */
public class NonSITableScanner<Data> implements StandardIterator<ExecRow>,AutoCloseable{
    ...
    private static Logger LOG = Logger.getLogger(NonSITableScanner.class);
    ...
    protected NonSITableScanner(DataScanner scanner,
