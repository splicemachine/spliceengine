...
import com.splicemachine.derby.procedures.SpliceTableAdmin;
...
public class CheckTableUtils {
    ...
    private static Logger LOG=org.apache.logging.log4j.LogManager.getLogger(CheckTableUtils.class);
