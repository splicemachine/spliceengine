 ...
 */
public abstract class SparkOperation<Op extends SpliceBaseOperation, From, To>
		implements Function<From, To>, Externalizable {
	...
	protected SparkOperation(Op spliceOperation, SpliceObserverInstructions soi) {
		this.soi = soi;
