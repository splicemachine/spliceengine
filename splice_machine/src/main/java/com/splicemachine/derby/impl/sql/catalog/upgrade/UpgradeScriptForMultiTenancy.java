 ...
 */
public class UpgradeScriptForMultiTenancy extends UpgradeScriptBase {
    public UpgradeScriptForMultiTenancy(SpliceDataDictionary sdd, TransactionController tc) {
        super(sdd, tc);
    }
