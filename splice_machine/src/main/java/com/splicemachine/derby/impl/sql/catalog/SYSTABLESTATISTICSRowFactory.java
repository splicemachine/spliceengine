...
public class SYSTABLESTATISTICSRowFactory extends CatalogRowFactory {
    ...
    public static ColumnDescriptor[] getViewColumns(TableDescriptor view,UUID viewId) throws StandardException {
        ...
        return new ColumnDescriptor[]{
                ...
                new ColumnDescriptor("AVG_LOCAL_READ_LATENCY"   ,12,longType,null,null,view,viewId,0,0,11),
                new ColumnDescriptor("AVG_REMOTE_READ_LATENCY"  ,13,longType,null,null,view,viewId,0,0,12),
                new ColumnDescriptor("AVG_WRITE_LATENCY"        ,14,longType,null,null,view,viewId,0,0,13),
        };
    }
