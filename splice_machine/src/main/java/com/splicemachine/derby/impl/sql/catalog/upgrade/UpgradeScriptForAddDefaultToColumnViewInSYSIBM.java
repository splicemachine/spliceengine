...
/**
 * Created by yxia on 2/6/20.
 */
public class UpgradeScriptForAddDefaultToColumnViewInSYSIBM extends UpgradeScriptBase {
    public UpgradeScriptForAddDefaultToColumnViewInSYSIBM(SpliceDataDictionary sdd, TransactionController tc) {
        super(sdd, tc);
    }
