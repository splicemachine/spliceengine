...
//        return (new OpenConglomerateScratchSpace(format_ids,collation_ids,hasCollatedTypes));
    ...
    public CatalogMessage.DataValueDescriptor toProtobuf() throws IOException {
        ...
        CatalogMessage.DataValueDescriptor dvd = CatalogMessage.DataValueDescriptor.newBuilder()
                .setType(CatalogMessage.DataValueDescriptor.Type.HBaseConglomerate)
                .setExtension(CatalogMessage.HBaseConglomerate.hbaseConglomerate, spliceConglomerate)
                .build();
        return dvd;
    }
    /**
    ...
    private void localReadExternalNew(ObjectInput in) throws IOException {
        ...
        CatalogMessage.HBaseConglomerate spliceConglomerate =
                dvd.getExtension(CatalogMessage.HBaseConglomerate.hbaseConglomerate);
