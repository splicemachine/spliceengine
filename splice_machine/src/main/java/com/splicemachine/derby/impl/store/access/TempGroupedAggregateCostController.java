...
public class TempGroupedAggregateCostController implements AggregateCostController{
    ...
    public CostEstimate estimateAggregateCost(CostEstimate baseCost) throws StandardException{
        ...
        newEstimate.setLocalCostPerParallelTask(newEstimate.localCost(), newEstimate.getParallelism());
        newEstimate.setRemoteCostPerParallelTask(newEstimate.remoteCost(), newEstimate.getParallelism());
