...
public class TempGroupedAggregateCostController implements AggregateCostController{
    ...
    public CostEstimate estimateAggregateCost(CostEstimate baseCost) throws StandardException{
        ...
        newEstimate.setLocalCostPerPartition(newEstimate.localCost(), newEstimate.getParallelism());
        newEstimate.setRemoteCostPerPartition(newEstimate.remoteCost(), newEstimate.getParallelism());
