...
public class DeletePipelineWriter extends AbstractPipelineWriter<ExecRow>{
    ...
    public DeletePipelineWriter(String tableVersion,TxnView txn,byte[] token,long heapConglom,OperationContext operationContext, ExecRow execRow) throws StandardException {
        super(tableVersion, txn, token, heapConglom,operationContext,execRow);
    ...
    public void open(TriggerHandler triggerHandler, SpliceOperation operation) throws StandardException {
        ...
        try{
            writeBuffer=writeCoordinator.writeBuffer(destinationTable,txn,null,Metrics.noOpMetricFactory(),execRow);
        ...
        try {
            ...
            if (tableVersion.equals("3.0")) {
                unsafeRecord = new UnsafeRecord(
                        ...
                        0l, true);
                unsafeRecord.setNumberOfColumns(0);
