 ...
 */
public class GetNLJoinLeftOuterIterator extends GetNLJoinIterator {

    public GetNLJoinLeftOuterIterator() {}

    public GetNLJoinLeftOuterIterator(OperationContext operationContext, LocatedRow locatedRow) {
