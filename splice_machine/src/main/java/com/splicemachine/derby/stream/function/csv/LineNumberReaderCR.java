...
public class LineNumberReaderCR extends BufferedReaderCR {
     ...
     */
    public LineNumberReaderCR(Reader in, boolean skipCarriageReturn) {
        super(in, skipCarriageReturn);
    }
     ...
     */
    public LineNumberReaderCR(Reader in, int sz, boolean skipCarriageReturn) {
        super(in, sz, skipCarriageReturn);
    }
