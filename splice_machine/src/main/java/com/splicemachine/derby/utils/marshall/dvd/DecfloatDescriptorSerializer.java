...
/**
 */
class DecfloatDescriptorSerializer implements DescriptorSerializer {
		private static final DescriptorSerializer INSTANCE = new DecfloatDescriptorSerializer();
		public static final Factory INSTANCE_FACTORY = new Factory() {
				...
				@Override public boolean applies(int typeFormatId) { return typeFormatId == StoredFormatIds.SQL_DECFLOAT_ID; }
		...
		private DecfloatDescriptorSerializer() { }
