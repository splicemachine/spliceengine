...
/**
  ...
  */
@SerialVersionUID(20200517232L)
@SuppressFBWarnings(value = Array("NP_ALWAYS_NULL, NP_LOAD_OF_KNOWN_NULL_VALUE"), justification = "These fields usually are not null")
