...
public class WriteCoordinator {
    ...
    public void registerJMX(MBeanServer mbs) throws MalformedObjectNameException, NotCompliantMBeanException, InstanceAlreadyExistsException, MBeanRegistrationException {
        ObjectName coordinatorName = new ObjectName(PipelineConstants.WRITE_COORDINATOR_OBJECT_LOCATION);
    ...
    public RecordingCallBuffer<KVPair> writeBuffer(byte[] tableName, TxnView txn) {
        return writeBuffer(tableName,txn, PipelineConstants.noOpFlushHook);
    }
    ...
    public RecordingCallBuffer<KVPair> noIndexWriteBuffer(byte[] tableName, TxnView txn, final MetricFactory metricFactory) {
        ...
        monitor.outstandingBuffers.incrementAndGet();
        return new MonitoredPipingCallBuffer(tableName, txn, asynchronousWriter, PipelineConstants.noOpFlushHook, config, monitor, true);
   }
    ...
    public RecordingCallBuffer<KVPair> writeBuffer(byte[] tableName, TxnView txn, WriteConfiguration writeConfiguration) {
        return writeBuffer(tableName, txn, PipelineConstants.noOpFlushHook, writeConfiguration);
    }
    ...
    public RecordingCallBuffer<KVPair> writeBuffer(byte[] tableName, TxnView txn, final int maxEntries) {
        ...
        monitor.outstandingBuffers.incrementAndGet();
        return new MonitoredPipingCallBuffer(tableName, txn, asynchronousWriter, PipelineConstants.noOpFlushHook, defaultWriteConfiguration, config, false);
    }
