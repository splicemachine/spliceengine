...
public class BaseHRegionServer implements AdminProtos.AdminService.BlockingInterface, Server, PriorityFunction {
    ...
    public QuotaProtos.GetSpaceQuotaSnapshotsResponse getSpaceQuotaSnapshots(RpcController var1, QuotaProtos.GetSpaceQuotaSnapshotsRequest var2) throws ServiceException {
        throw new UnsupportedOperationException("Not implemented");
    }
