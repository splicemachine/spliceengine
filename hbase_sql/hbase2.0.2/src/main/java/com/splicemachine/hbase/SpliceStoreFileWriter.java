...
public class SpliceStoreFileWriter {
    ...
    private StoreFileWriter writer;
    public static final byte[] BULKLOAD_TIME_KEY = HStoreFile.BULKLOAD_TIME_KEY;
    public static final byte[] BULKLOAD_TASK_KEY = HStoreFile.BULKLOAD_TASK_KEY;
    public static final byte[] MAJOR_COMPACTION_KEY = HStoreFile.MAJOR_COMPACTION_KEY;
    public static final byte[] EXCLUDE_FROM_MINOR_COMPACTION_KEY = HStoreFile.EXCLUDE_FROM_MINOR_COMPACTION_KEY;

    public SpliceStoreFileWriter(StoreFileWriter writer) {
        this.writer = writer;
    }
    ...
    public static class Builder {
        private StoreFileWriter.Builder builder;

        public Builder(Configuration conf, CacheConfig cacheConf, FileSystem fs) {
            builder = new StoreFileWriter.Builder(conf, cacheConf, fs);
        }
