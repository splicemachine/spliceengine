...
public abstract class SnapshotUtilsBase implements SnapshotUtils {
    ...
    public Path materializeRefFile(Configuration conf,
        ...
        Path localDir = new Path(region.getRegionFileSystem().getRegionDir() + "/.tmp");
        ...
        HColumnDescriptor family = region.getTableDesc().getFamily(SIConstants.DEFAULT_FAMILY_BYTES);
