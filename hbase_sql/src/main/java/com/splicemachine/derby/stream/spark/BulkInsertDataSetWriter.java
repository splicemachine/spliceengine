...
public class BulkInsertDataSetWriter extends BulkDataSetWriter implements DataSetWriter {
     ...
     */
    private void doOutputKeysOnly(Activation activation, TableDescriptor td, ConglomerateDescriptorList list,
                                  List<Long> allCongloms, ArrayList<DDLMessage.TentativeIndex> tentativeIndexList)
            throws StandardException
    {
        long indexConglom = -1;
     ...
     * col 3 = fileName
     */
    private SparkDataSet getResultSet() throws StandardException
    {
