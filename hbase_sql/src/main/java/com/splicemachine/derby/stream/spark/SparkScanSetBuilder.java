    ...
    public DataSet<V> buildDataSet(Object caller) throws StandardException {
        ...
        if (storedAs!= null) {
            ...
            if (storedAs.equals("P"))
                locatedRows = dsp.readParquetFile(baseColumnMap,location,operationContext,qualifiers,null,execRow);
            if (storedAs.equals("O"))
                locatedRows = dsp.readORCFile(baseColumnMap,location,operationContext,qualifiers,null,execRow);
            else {
