 ...
 *
 */
public class ByteColumnBlock extends AbstractColumnBlock {

    public ByteColumnBlock(ColumnVector columnVector, DataType type) {
        super(columnVector,type);
    }
    @Override
    public Object getObject(int i) {
        return columnVector.isNullAt(i)?null:columnVector.getByte(i);
    }
