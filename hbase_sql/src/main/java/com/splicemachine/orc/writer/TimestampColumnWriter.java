...
import com.splicemachine.orc.stream.LongOutputStreamV1;
        ...
        implements ColumnWriter
{
    ...
    public TimestampColumnWriter(int column, DataType type, CompressionKind compression, int bufferSize, boolean isDwrf, DateTimeZone hiveStorageTimeZone)
    {
