        ...
        implements ValueSet
{
    ...
    @JsonCreator
    public AllOrNoneValueSet(@JsonProperty("type") DataType type, @JsonProperty("all") boolean all)
    {
        this.type = requireNonNull(type, "type is null");
        this.all = all;
    }

    static AllOrNoneValueSet all(DataType type)
    {
        return new AllOrNoneValueSet(type, true);
    }

    static AllOrNoneValueSet none(DataType type)
    {
