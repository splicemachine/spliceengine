...
{
    static ValueSet none(DataType type)
    {
        if (type.isOrderable()) {
    ...
    static ValueSet all(DataType type)
    {
        if (type.isOrderable()) {
    ...
    static ValueSet of(DataType type, Object first, Object... rest)
    {
        if (type.isOrderable()) {
    ...
    static ValueSet copyOf(DataType type, Collection<Object> values)
    {
        if (type.isOrderable()) {
    ...
    static ValueSet copyOfRanges(DataType type, Collection<Range> ranges)
    {
