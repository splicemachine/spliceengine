...
public class IntDictionaryStreamReader
    ...
    public IntDictionaryStreamReader(StreamDescriptor streamDescriptor)
    {
            ...
            throws IOException
    {
        ...
        for (int i = 0, j = 0; i < nextBatchSize; i++) {
            ...
            if (nullVector[i]) {
                ...
                vector.appendInt((int)dictionary[((int) dataVector[i])]);
            }
            else {
                vector.appendInt((int)dataVector[i]);
            }
        }
