...
public class OrcWriteValidation
{
    ...
    public static class WriteChecksumBuilder
    {
        ...
        private WriteChecksumBuilder(List<DataType> types)
        {
        ...
        public static WriteChecksumBuilder createWriteChecksumBuilder(Map<Integer, DataType> readColumns)
        {
            ...
            for (int column = 0; column < columnCount; column++) {
                DataType type = readColumns.get(column);
    ...
    public static class OrcWriteValidationBuilder
    {
        ...
        public OrcWriteValidationBuilder(List<DataType> types)
        {
