...
public class OrPredicateTest {
    ...
    public void testMatchesOrsAndAnds() throws Exception {
        ...
        Predicate firstPred = new ValuePredicate(CompareOp.EQUAL,0,first,true,false);
        Predicate secondPred = new ValuePredicate(CompareOp.EQUAL,1,second,true,false);
        Predicate thirdPred = new ValuePredicate(CompareOp.EQUAL,0,first,true,false);
        Predicate fourthPred = new ValuePredicate(CompareOp.EQUAL,1,third,true,false);
    ...
    public void testMatchesOneColumnNull() throws Exception {
        ...
        Predicate pred1 = new ValuePredicate(CompareOp.LESS,0,encoded1,true,false);
    ...
    public void testMatchesOneColumnNullAnotherWrongColumn() throws Exception {
        byte[] encoded1 = Encoding.encode(10030);
        Predicate pred1 = new ValuePredicate(CompareOp.LESS,1,encoded1,true,false);
        Predicate pred2 = new NullPredicate(false,false,0,false,false);
    ...
    public void testNoPredicatesCheckAfterCausesOrNotToCheckAfter() throws Exception {
        byte[] encoded1 = Encoding.encode(10030);
        Predicate pred1 = new ValuePredicate(CompareOp.LESS_OR_EQUAL,0,encoded1,false,true);
        Predicate pred2 = new ValuePredicate(CompareOp.GREATER_OR_EQUAL,0,encoded1,false,true);
