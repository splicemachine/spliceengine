...
public class EntryPredicateFilterTest {
    ...
    public void testPredicateWorksOnMultiKeyAndPredicate() throws Exception {
        ...
        Predicate p1 = new ValuePredicate(CompareOp.EQUAL,0,Encoding.encode(1250),true,false);
        Predicate p2 = new ValuePredicate(CompareOp.EQUAL,1,Encoding.encode(3),true,false);
        Predicate p3 = new ValuePredicate(CompareOp.EQUAL,2,Encoding.encode(1155),true,false);
    ...
    public void testOrPredicateAppliesWithImplicitlyMissingField() throws Exception {
        ...
        Predicate pred1 = new ValuePredicate(CompareOp.LESS,0,Encoding.encode(testField1),true,false);
    ...
    public void testEntryPredicateFilterFiltersRowsWithDontMatchPredicate() throws Exception {
        ...
        Predicate pred = new ValuePredicate(CompareOp.EQUAL,1, Encoding.encode("test2"),true,false);
    ...
    public void testReturnsEverythingThatMatchesPredicate() throws Exception {
     String testType1 = "test";
     BigDecimal testType2 = new BigDecimal("2.345");
     Predicate pred = new ValuePredicate(CompareOp.EQUAL,0, Encoding.encode(testType1),true,false);
        EntryPredicateFilter predicateFilter = new EntryPredicateFilter(new BitSet(),
        		ObjectArrayList.from(pred),true);
