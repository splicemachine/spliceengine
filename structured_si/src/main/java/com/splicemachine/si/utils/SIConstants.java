...
public class SIConstants {
	...
	public static final byte[] TRANSACTION_START_TIMESTAMP_COLUMN = Bytes.toBytes(0);
	public static final byte[] TRANSACTION_COMMIT_TIMESTAMP_COLUMN = Bytes.toBytes(1);
	...
	public static final byte[] SNAPSHOT_ISOLATION_COMMIT_TIMESTAMP_COLUMN = Bytes.toBytes(0);		
	public static final byte[] SNAPSHOT_ISOLATION_TOMBSTONE_COLUMN = Bytes.toBytes(1);	
