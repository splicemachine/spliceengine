...
import com.gotometrics.orderly.FixedUnsignedIntWritableRowKey;
import com.gotometrics.orderly.RowKey;

public class TestFixedUnsignedIntWritableRowKey 
  extends TestFixedIntWritableRowKey
{
  ...
  public int compareTo(Object o1, Object o2) {
    long x = ((IntWritable)o1).get() ^ Integer.MIN_VALUE,
         y = ((IntWritable)o2).get() ^ Integer.MIN_VALUE;
