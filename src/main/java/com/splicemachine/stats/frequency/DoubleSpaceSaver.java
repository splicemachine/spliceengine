 ...
 *         Date: 2/18/15
 */
public class DoubleSpaceSaver extends ObjectSpaceSaver<Double> implements DoubleFrequencyCounter {
    ...
    @Override
    public Set<? extends FrequencyEstimate<Double>> getFrequentElements(float support) {
