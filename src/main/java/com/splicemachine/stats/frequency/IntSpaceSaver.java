 ...
 *         Date: 2/18/15
 */
public class IntSpaceSaver extends ObjectSpaceSaver<Integer> implements IntFrequencyCounter {
    ...
    @Override
    public Set<? extends FrequencyEstimate<Integer>> getFrequentElements(float support) {
