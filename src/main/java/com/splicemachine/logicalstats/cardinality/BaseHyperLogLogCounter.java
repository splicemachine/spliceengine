 ...
 * {@link com.splicemachine.logicalstats.cardinality.AdjustedHyperLogLogCounter}, and thus this implementation
 * should be favored only when the expected cardinality is very high.</p>
 *
 * @see com.splicemachine.logicalstats.cardinality.AdjustedHyperLogLogCounter
