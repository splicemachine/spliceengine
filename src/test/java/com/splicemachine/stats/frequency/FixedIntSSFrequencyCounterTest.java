...
public class FixedIntSSFrequencyCounterTest {
		...
		public void testWorksWithNoEviction() throws Exception {
				...
				IntFrequencyCounter spaceSaver = new IntSSFrequencyCounter(20,10, HashFunctions.murmur3(0));
		...
		public void testEvictsEntry() throws Exception {
				IntFrequencyCounter spaceSaver = new IntSSFrequencyCounter(2,10, HashFunctions.murmur3(0));
