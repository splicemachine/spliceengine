...
public class FixedFloatSSFrequencyCounterTest {
		...
		public void testWorksWithNoEviction() throws Exception {
				...
				FloatFrequencyCounter spaceSaver = FrequencyCounters.floatCounter(20,10);//new FloatSSFrequencyCounter(20,10, HashFunctions.murmur3(0));
        ...
        FloatFrequentElements estimates = spaceSaver.heavyHitters(0f);
...
//				Assert.assertEquals("Total estimated count does not equal the number of elements!",15,totalCount);
		...
		public void testEvictsEntry() throws Exception {
				FloatFrequencyCounter spaceSaver = FrequencyCounters.floatCounter(2,10);//new FloatSSFrequencyCounter(2,10, HashFunctions.murmur3(0));
